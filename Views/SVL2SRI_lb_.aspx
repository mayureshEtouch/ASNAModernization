<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="SVL2SRI_lb_.aspx.cs" Inherits="conns.SVL2SRI_lb_Form"  MasterPageFile="~/Themes/Current/MasterPage.master" %>
<%@ Register  TagPrefix="mdf" Assembly="ASNA.Monarch.WebDspF, Version=12.0.48.0, Culture=neutral, PublicKeyToken=71de708db13b26d3" Namespace="ASNA.Monarch.WebDspF" %>
    ...
    <asp:Content ID="FileContent1" runat="server" ContentPlaceHolderID="FKeyPH">
        <div id="Div0">
            ...
            <mdf:ddsfile id="SVL2SRI_lb_Control" runat="server" 
...
<!-- Modified HTML code ends here -->
 ...
 />
            <mdf:DdsConstant id="DdsConstant5" runat="server" 
              ...
              Text="Select Exchange Reason" 
              CssClass="DdsConstant"
 />
            <mdf:DdsCharField id="_lb_SFLCTL__lb_2MTCD" runat="server" style="position: absolute; left: 1px; top: 0px; width: 55px"
 ...
 />
            <mdf:DdsConstant id="DdsConstant6" runat="server" 
              style="position: absolute; left: 118px; top: 99px;"
              Text="Description" 
              VisibleCondition="81"
              Color="DarkBlue" 
              CssClass="DdsConstant"
 ...
 />
          <mdf:DdsSubfile id="_lb_SFLRCD" runat="server" 
            style="position: absolute; left: 0px; top: 144px; width: 378px; height: 24px" 
            Alias="#SFLRCD"
          ...
          <%--  Dsc: Exchange Reason                                                                                             --%>
          <%-- =========================================================================                                         --%>
            <mdf:DdsCharField id="_lb_SFLRCD__lb_1MUCD" runat="server" style="position: absolute; left: 1px; top: 0px; width: 28px"
              CssClass="DdsCharField"
              Length="3" 
              Alias="#1MUCD" 
              Usage="Hidden" 
 ...
 />
            <mdf:DdsCharField id="_lb_SFLRCD__lb_1SEL" runat="server" style="position: absolute; left: 19px; top: 0px; width: 37px"
              ...
              Values="' ' '1' " 
              TabIndex="1"  />
            <mdf:DdsCharField id="_lb_SFLRCD__lb_1MTCD" runat="server" style="position: absolute; left: 73px; top: 0px; width: 55px"
              CssClass="DdsCharField"
              Length="6" 
              Alias="#1MTCD" 
              Usage="OutputOnly" 
              VirtualRowCol="7,5" 
 />
            <mdf:DdsCharField id="_lb_SFLRCD__lb_1Q5TX" runat="server" style="position: absolute; left: 145px; top: 0px; width: 226px"
              CssClass="DdsCharField"
              Length="25" 
              Alias="#1Q5TX" 
              Usage="OutputOnly" 
