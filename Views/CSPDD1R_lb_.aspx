...
<%@ Register  TagPrefix="mdf" Assembly="ASNA.Monarch.WebDspF, Version=12.0.49.0, Culture=neutral, PublicKeyToken=71de708db13b26d3" Namespace="ASNA.Monarch.WebDspF" %>
    ...
    <asp:Content ContentPlaceHolderID="HeaderPH" runat="Server" >
        <%-- Migrated on 6/15/2017 at 5:09 PM by ASNA Monarch(R) Wings version 7.0.58.0 --%>
 ...
 />
          ...
          <mdf:DdsRecord id="_lb_RCDDTL1" runat="server" 
            style="position: relative; width: 675px; height: 168px" 
            Alias="#RCDDTL1"
            CssClass="DdsRecord"
            AttnKeys="F3 'Exit.' 03;F12 'Exit.' 12;Clear 'CLEAR.' 26;Help 'Help.' 25;"
            FuncKeys="F4 'Prompt.' 04;F5 'Reset.' 05;"
 ...
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_1CVID" runat="server" style="position: absolute; left: 208px; top: 96px; width: 271px"
              ...
              VirtualRowCol="5,23" 
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_1X8XT" runat="server" style="position: absolute; left: 19px; top: 144px; width: 649px"
              CssClass="DdsCharField"
              Length="72" 
              Alias="#1X8XT" 
              VisibleCondition="!( 78 )"
      ...
      <script>
          var copyToAndFrom = {
            "displayOnlyFields": {
              ...
              "CenPH__lb_RCDDTL1__lb_1X8XT":"custMsg"
            },
            "inputFields": {
