...
<asp:Content ID="FileContent2" runat="server" ContentPlaceHolderID="CenPH">
                        ...
                        <div class="content-grid mdl-grid">
                            ...
                            <div class="mdl-cell mdl-cell--10-col search-container">
                                <div class="content-grid mdl-grid">
                                    ...
                                    <div class="mdl-cell mdl-cell--2-col-desktop mdl-cell--2-col" id="filter-by-co">
                                        <input type="text" id="modelNumber" class="mdl-textfield__input" value="" data-tb-index="1" maxlength="20" style="width:120px">
                                    </div>
                                    <div class="mdl-cell mdl-cell--1-col" style="width:40px">
                                        <span class="summary-table-title pull-right">Loc</span>
                                    </div>
                                    <div class="mdl-cell mdl-cell--1-col-desktop mdl-cell--1-col" id="filter-by-co" style="width:40px">
                                        <input type="text" id="loc" class="mdl-textfield__input" value="" data-tb-index="1" maxlength="3" style="width:40px">
                                    </div>
                                    ...
                                    <div class="mdl-cell mdl-cell--1-col-desktop mdl-cell--1-col" id="filter-by-co">
                                        <select name="status" id="status" data-tb-index="2" style="margin-top: 8px;width:160px">
 ...
 />
            <mdf:DdsConstant id="DdsConstant12" runat="server" 
              ...
              CssClass="DdsConstant"
 />
            <mdf:DdsCharField id="_lb_SFLCTL__lb_2AXTX" runat="server" style="position: absolute; left: 55px; top: 96px; width: 181px"
              CssClass="DdsCharField"
              Length="20" 
              Alias="#2AXTX" 
              Usage="Both" 
              ...
              TabIndex="1"  />
            <mdf:DdsCharField id="_lb_SFLCTL__lb_2AACD" runat="server" style="position: absolute; left: 541px; top: 96px; width: 28px"
              CssClass="DdsCharField"
              Length="3" 
              Alias="#2AACD" 
              Usage="Both" 
