...
<%@ Register  TagPrefix="mdf" Assembly="ASNA.Monarch.WebDspF, Version=12.0.49.0, Culture=neutral, PublicKeyToken=71de708db13b26d3" Namespace="ASNA.Monarch.WebDspF" %>
    ...
    <asp:Content ContentPlaceHolderID="HeaderPH" runat="Server" >
        <%-- Migrated on 6/12/2017 at 3:40 PM by ASNA Monarch(R) Wings version 7.0.58.0 --%>
                ...
                <div class="table-container filter-search-container">
                    <div class="content-grid mdl-grid">
                        ...
                        <div class="mdl-cell mdl-cell--10-col search-container">
                            <div class="content-grid mdl-grid">
                                <div class="mdl-cell mdl-cell--1-col"  style="margin-left: 35px;"> <span class="summary-table-title pull-right" style="margin-left: -5px;">Lease Id</span> </div>
                                ...
                                <div class="mdl-cell mdl-cell--2-col"> <span class="summary-table-title pull-right" style="margin-left: -5px;">First Name</span> </div>
                                <div class="mdl-cell mdl-cell--2-col mdl-cell mdl-cell--1-col-tablet">
                                    <input type="text"  id="CenPH__lb_SFLCTL__lb_CYRXT_new" class="mdl-textfield__input" data-tb-index="2">
                                </div>
                                <div class="mdl-cell mdl-cell--2-col"> <span class="summary-table-title pull-right" style="margin-left: -5px;">Last Name</span> </div>
                                <div class="mdl-cell mdl-cell--2-col mdl-cell mdl-cell--1-col-tablet">
