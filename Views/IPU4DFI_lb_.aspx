<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="IPU4DFI_lb_.aspx.cs" Inherits="CONNS.IPU4DFI_lb_Form"  MasterPageFile="~/Themes/Current/MasterPage.master" %>
<%@ Register  TagPrefix="mdf" Assembly="ASNA.Monarch.WebDspF, Version=14.0.36.0, Culture=neutral, PublicKeyToken=71de708db13b26d3" Namespace="ASNA.Monarch.WebDspF" %>

    <asp:Content ContentPlaceHolderID="HeaderPH" runat="Server" >
        <%-- Migrated on 7/31/2018 at 5:28 PM by ASNA Monarch(R) Wings version 8.0.40.0 --%>
        <%-- Legacy location: library ASNATRACK, file QDDSSRC, member IPU4DFI# --%>
    ...
    <asp:Content ID="FileContent1" runat="server" ContentPlaceHolderID="FKeyPH">
        <div id="Div0">
            ...
            <mdf:ddsfile id="IPU4DFI_lb_Control" runat="server" 
	...
	<!-- Modified HTML code starts here -->
      ...
      <%--  SY: DSW Select Printer1   Display file                                                                           --%>
      <%--  CRTDSPF                                                                                                          --%>
      <%--  RSTDSP(*YES)                                                                                                     --%>
      <%--  MEMBER-ID: IPU4DFI#                                                                                              --%>
      <%--                                                                                                                   --%>
 ...
 />
	...
	<script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                generateDataTable("select-printer", "table#__Page_PopUp #CenPH__lb_SFLRCD", "next", dataMergeIndices, false);
