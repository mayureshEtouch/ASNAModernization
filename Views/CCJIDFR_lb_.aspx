<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="CCJIDFR_lb_.aspx.cs" Inherits="conns.CCJIDFR_lb_Form"  MasterPageFile="~/Themes/Current/MasterPage.master" %>
<%@ Register  TagPrefix="mdf" Assembly="ASNA.Monarch.WebDspF, Version=12.0.48.0, Culture=neutral, PublicKeyToken=71de708db13b26d3" Namespace="ASNA.Monarch.WebDspF" %>

    <asp:Content ContentPlaceHolderID="HeaderPH" runat="Server" >
        <%-- Migrated on 8/19/2016 at 2:00 PM by ASNA Monarch(R) Wings version 7.0.58.0 --%>
        <%-- Legacy location: library asnaph4bk, file QDDSSRC, member CCJIDFR# --%>
    ...
    <asp:Content ID="FileContent1" runat="server" ContentPlaceHolderID="FKeyPH">
        <div id="Div0">
            ...
            <mdf:ddsfile id="CCJIDFR_lb_Control" runat="server" 
    ...
    <asp:Content ID="FileContent2" runat="server" ContentPlaceHolderID="CenPH">
                ...
                <section class="time-date">
                    <div class="content-grid mdl-grid">
                        <div class="mdl-cell mdl-cell--9-col mdl-cell--6-col-tablet">
                            <!-- Title -->
                            <span class="heading-h1">Credit Application Notes</span> </div>
                        <div class="mdl-cell mdl-cell--3-col mdl-cell--2-col-tablet pull-right">
                            <!-- Navigation -->
                            <i class="material-icons md-15 md-light computer-icon"></i> <span class="date-time-txt">CCJIDFR</span></div>
                    </div>
                </section>
                    ...
                    <div class="table-data-wrapper">
                        <div class="table-data-maincontainer">
                            <div style="overflow: auto;" class="table-container">
                                <div>
                                    <table cellspacing="0" cellpadding="0" border="0" class="mdl-data-table mdl-js-data-table mdl-shadow--2dp navigateable is-upgraded" id="notes" data-upgraded=",MaterialDataTable">
                                        <thead>
                                            <tr>
                                                <th>Notes</th>
                                            </tr>
      ...
      <%--  CA: DFW Notes-Display     Display file                                                               --%>
      <%--  CRTDSPF                                                                                              --%>
      <%--  RSTDSP(*YES)                                                                                         --%>
      <%--  MEMBER-ID: CCJIDFR#                                                                                  --%>
      <%--                                                                                                       --%>
