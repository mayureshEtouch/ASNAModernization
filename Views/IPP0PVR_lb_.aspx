<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="IPP0PVR_lb_.aspx.cs" Inherits="CONNS.IPP0PVR_lb_Form"  MasterPageFile="~/Themes/Current/MasterPage.master" %>
...
<!-- #Include virtual="~/Views/PopupHeader.aspx" -->
    ...
    <asp:Content ID="FileContent1" runat="server" ContentPlaceHolderID="FKeyPH">
        <div id="Div0">
            ...
            <mdf:ddsfile id="IPP0PVR_lb_Control" runat="server" 
    ...
    <section class="time-date">
      <div class="content-grid mdl-grid">
        <div class="mdl-cell mdl-cell--9-col"> 
          <!-- Title --> 
          <span class="heading-h1">Information!!!</span> </div>
        <div class="mdl-cell mdl-cell--3-col pull-right"> 
          <!-- Navigation --> 
          <i class="material-icons md-15 md-light computer-icon"></i> <span class="date-time-txt">IPP0PVR</span></div>
      </div>
    </section>
...
<!-- Modified HTML code ends here -->
      ...
      <%--  OE: PMT Dsp Order canc    Prompt & validate record                                                               --%>
      <%--  CRTDSPF                                                                                                          --%>
      <%--  RSTDSP(*YES)                                                                                                     --%>
      <%--  MEMBER-ID: IPP0PVR#                                                                                              --%>
      <%--                                                                                                                   --%>
