		...
		<section class="time-date">
				<div class="content-grid mdl-grid">
						<div class="mdl-cell mdl-cell--9-col"> 
								<!-- Title --> 
								<span class="heading-h1">Edit Application Product</span> </div>
						<div class="mdl-cell mdl-cell--3-col pull-right"> 
								<!-- Navigation --> 
								<i class="material-icons md-15 md-light computer-icon"></i> <span class="date-time-txt">CCJEE1R</span></div>
				</div>
		</section>
		<section class="form-data">
                <div class="form-data-wrapper" style="padding-bottom:0;">							
                      ...
                      <div class="content-grid mdl-grid">
                        	...
                        	<div class="mdl-cell mdl-cell--3-col mdl-cell--4-col-tablet">
                           		<span class="form-text"><input class="mdl-textfield__input" type="text" data-tb-index="1" size="15" id="CenPH__lb_RCDDTL1__lb_1PRDC_new" onfocus="_09('#1PRDC','4,6','#RCDDTL1');" maxlength="3"></span></span>
                        	</div>
                   	</div>
                  </div>
									<!-- col ends here -->
                      ...
                      <div class="content-grid mdl-grid">
                        	...
                        	<div class="mdl-cell mdl-cell--5-col mdl-cell--5-col-tablet">
                           		<span class="form-text"><input class="mdl-textfield__input" type="text" data-tb-index="2" size="15" id="CenPH__lb_RCDDTL1__lb_1AXTX_new" onfocus="_09('#1AXTX','4,16','#RCDDTL1');" maxlength="20"></span></span>
                        	</div>
                   	</div>
                  </div>
									<!-- col ends here -->
                      ...
                      <div class="content-grid mdl-grid">
                        	...
                        	<div class="mdl-cell mdl-cell--3-col mdl-cell--4-col-tablet">
                           		<span class="form-text"><input class="mdl-textfield__input" type="text" data-tb-index="3" size="15" id="CenPH__lb_RCDDTL1__lb_1PRDQ_new" onfocus="_09('#1PRDQ','5,6','#RCDDTL1');"></span></span>
                        	</div>
                   	</div>
                  </div>
									<!-- col ends here -->
                      ...
                      <div class="content-grid mdl-grid">
                        	...
                        	<div class="mdl-cell mdl-cell--5-col mdl-cell--5-col-tablet">
                           		<span class="form-text"><input class="mdl-textfield__input" type="text" data-tb-index="4" size="15" id="CenPH__lb_RCDDTL1__lb_1GFVA_new" onfocus="_09('#1GFVA','5,15','#RCDDTL1');"></span></span>
                        	</div>
                   	</div>
                  </div>
									<!-- col ends here -->
                      ...
                      <div class="content-grid mdl-grid">
                        	...
                        	<div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet">
                           		<span class="form-text"><input class="mdl-textfield__input" type="text" data-tb-index="5" size="15" id="CenPH__lb_RCDDTL1__lb_1PRDM_new" onfocus="_09('#1PRDM','5,31','#RCDDTL1');"></span></span>
                        	</div>
                   	</div>
                  </div>
									<!-- col ends here -->
...
<div class="modal-dialog-container">
		...
		<section class="time-date">
				<div class="content-grid mdl-grid">
						<div class="mdl-cell mdl-cell--9-col"> 
								<!-- Title --> 
								<span class="heading-h1">Edit Details</span> </div>
						<div class="mdl-cell mdl-cell--3-col pull-right"> 
								<!-- Navigation --> 
								<i class="material-icons md-15 md-light computer-icon"></i> <span class="date-time-txt">CCJEE1R</span></div>
				</div>
    ...
    <asp:Content ContentPlaceHolderID="PageScriptPH" runat="server" >
        ...
        var copyToAndFrom = {
            ...
            "inputFields": {
                ...
                "CenPH__lb_RCDKEY__lb_1APD_lb_": "CenPH__lb_RCDKEY__lb_1APD_lb_new"
            }
        }
        function condition1() {
