    ...
    <div class="content-grid mdl-grid">
      <div class="mdl-cell mdl-cell--8-col"> 
        ...
        <div class="mdl-cell mdl-cell--4-col pull-right"> 
          <!-- Navigation --> 
          <i class="material-icons md-15 md-light computer-icon"></i> <span class="date-time-txt">CCX4DFR</span> <i class="material-icons md-15 md-light date-icon"></i> <span class="date-time-txt" name="date" id="date"></span> <i class="material-icons md-15 md-light time-icon"></i> &nbsp;<span class="date-time-txt" name="time" id="time"></span> </div>
        </div>
      </section>
                ...
                <div class="mdl-cell mdl-cell--6-col mdl-cell mdl-cell--4-col-tablet">
                  <div class="content-grid mdl-grid">
                    ...
                    <div  class="mdl-cell mdl-cell--8-col  mdl-cell--4-col-tablet" style="margin: 0"> 
                      <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH__lb_SFLCTL__lb_2ALTX_new"></span><br/>
                      <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH__lb_SFLCTL__lb_2ANTX_new"></span><br/>
                      <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH__lb_SFLCTL__lb_2AQTX_new"></span>
              ...
              <div class="content-grid mdl-grid" style="padding:0"> 
                ...
                <div class="mdl-cell mdl-cell--6-col mdl-cell mdl-cell--4-col-tablet">
                  <div class="content-grid mdl-grid">
                    ...
                    <div  class="mdl-cell mdl-cell--8-col  mdl-cell--4-col-tablet" style="margin: 0"> <span data-upgraded=",MaterialTextfield" class="form-text" id="ctl00$CenPH$_lb_SFLCTL_VCD9DT_new"></span> </div>
                  </div>
                </div>
                <!-- 6 col ends here --> 
              </div>
      ...
      <section class="table-data-content-container spacer-container-bottom mrgnTp16">
        <div class="table-data-wrapper">
          <div class="table-data-maincontainer">
            <div style="overflow: auto;" class="table-container">
              <div>
                <table cellspacing="0" cellpadding="0" border="0" class="mdl-data-table mdl-js-data-table mdl-shadow--2dp navigateable is-upgraded" id="phone_validation" data-upgraded=",MaterialDataTable">
                  <thead>
                    <tr>
                  ...
                  <div class="button-container">
                    <div class="content-grid mdl-grid">
                      <div class="mdl-cell mdl-cell--9-col mdl-cell--6-col-tablet"> <span class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="previous" event-data="F3">Previous</span> </div>
        ...
        $(document).ready(function () {
          ...
          var spanIds = [
          "CenPH__lb_SFLRCD__lb_RXBTX",
          "CenPH__lb_SFLRCD__lb_1ALTX",
          "CenPH_DdsConstant9",
          "CenPH__lb_SFLRCD__lb_1PYNB",
          "CenPH__lb_SFLRCD__lb_1W7TX",
          "CenPH__lb_SFLRCD__lb_1ANTX",
          "CenPH_DdsConstant10",
          "CenPH__lb_SFLRCD__lb_1PZNB",
          "CenPH__lb_SFLRCD__lb_1AQTX",
          "CenPH__lb_SFLRCD__lb_1W6TX",
          "CenPH__lb_SFLRCD__lb_1APTX",
          "CenPH_DdsConstant11",
          "CenPH__lb_SFLRCD__lb_1CUCO",
          "CenPH_DdsConstant8",
          ];
          var dataMergeIndices = [[0], [1], [3], [4], [5, "&nbsp;", 8, "&nbsp;", 9, "&nbsp;", 10], [7], [12]];
          generateTableAndApplyInfiniteScroll("phone_validation", "CenPH__lb_SFLRCD", "NONE", "NONE", dataMergeIndices, "DISABLE_DOUBLE_CLICK",spanIds);
