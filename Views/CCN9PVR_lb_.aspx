...
<div class="modal-dialog-container">
  <header class="mdl-layout__header">
   ...
   function setFocus(){
    var focus_ele_name = $("#__focusID__").val();
    if(focus_ele_name != undefined && focus_ele_name.length>0){
      focus_ele_name = focus_ele_name.replace(/\$/g,'\\$');
      var focus_ele_id = $("input[name='"+focus_ele_name+"']").attr('id');
      if(focus_ele_id == undefined){
        var focus_ele_id = $("select[name='"+focus_ele_name+"']").attr('id');
      }
      if(focus_ele_id != undefined){
        $("#"+focus_ele_id+"_new").focus();
      }
    }
  }
});
