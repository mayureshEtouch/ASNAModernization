    ...
    <div class="content-grid mdl-grid">
      <div class="mdl-cell mdl-cell--8-col"> 
        ...
        <div class="mdl-cell mdl-cell--4-col pull-right"> 
          <!-- Navigation --> 
          <i class="material-icons md-15 md-light computer-icon"></i> <span class="date-time-txt">CCCVDFR</span> 
   ...
   <div class="button-container">
    <div class="content-grid mdl-grid">
      <div class="mdl-cell mdl-cell--10-col-desktop mdl-cell--7-col">
        ...
        <span class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" event-data="F9" id="">Adjust Refund</span>
