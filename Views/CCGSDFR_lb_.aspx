<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="CCGSDFR_lb_.aspx.cs" Inherits="conns.CCGSDFR_lb_Form"  MasterPageFile="~/Themes/Current/MasterPage.master" %>
<%@ Register  TagPrefix="mdf" Assembly="ASNA.Monarch.WebDspF, Version=12.0.48.0, Culture=neutral, PublicKeyToken=71de708db13b26d3" Namespace="ASNA.Monarch.WebDspF" %>

    <asp:Content ContentPlaceHolderID="HeaderPH" runat="Server" >
        <%-- Migrated on 9/9/2016 at 2:31 PM by ASNA Monarch(R) Wings version 7.0.58.0 --%>
        <%-- Legacy location: library ASNAPH5BK, file QDDSSRC, member CCGSDFR# --%>
    ...
    <asp:Content ID="FileContent1" runat="server" ContentPlaceHolderID="FKeyPH">
        <div id="Div0">
            ...
            <mdf:ddsfile id="CCGSDFR_lb_Control" runat="server" 
            ...
            <section class="time-date">
                <div class="content-grid mdl-grid">
                    <div class="mdl-cell mdl-cell--8-col">
                        <!-- Title -->
                        <span class="heading-h1">Display All Insurance Transactions</span>
                    </div>
                    <div class="mdl-cell mdl-cell--4-col pull-right">
                        <!-- Navigation -->
                        <i class="material-icons md-15 md-light computer-icon"></i> <span class="date-time-txt">CCGSDFR</span>
                ...
                <div class="content-grid mdl-grid">
                    <div class="mdl-cell mdl-cell--12-col pull-right">
                        <div class="icon-container">
                           <span id="delete"><span class="icon-txt delete">Delete</span><i class="material-icons md-15 md-light delete-icon delete"></i></span>
 ...
 <div id="modal1" class="simplePopup"></div>
      ...
      <%--  CR: DSP Ins Trans - All   Display file                                                                           --%>
      <%--  CRTDSPF                                                                                                          --%>
      <%--  RSTDSP(*YES)                                                                                                     --%>
      <%--  MEMBER-ID: CCGSDFR#                                                                                              --%>
      <%--                                                                                                                   --%>
 ...
 />
            <mdf:DdsConstant id="DdsConstant8" runat="server" 
              ...
              Text="Display All Insurance Transactions" 
              CssClass="DdsConstant"
 />
      ...
      <script type="text/javascript">
        var copyToAndFrom = {
            ...
            $(document).ready(function () {
              ...
              $('body').on('click', '#insurance tbody tr', function () {
                $("#insurance tbody tr:even").css("background-color", "#fff");
                $("#insurance tbody tr:odd").css("background-color", "#f9f9f9");
                $(this).css({ "background-color": "#d8d8d8" });
                $("#insurance tbody tr").removeClass("selected");
                $(this).addClass("selected");
                $("div.icon-container").removeClass("icon-disable");
              });
              var dataMergeIndices = [[0], [1], [2], [3], [4], [5], [6], [7]];
                generateTableAndApplyInfiniteScroll("insurance", "CenPH__lb_SFLRCD", "NONE", "next", dataMergeIndices);
              ...
              $("#delete").click(function (event) {
                if ($(".icon-container").hasClass("icon-disable")) {
                    alert("Please select the insurance Application");
                } else {
                    var row = $("#insurance tbody tr.selected");
