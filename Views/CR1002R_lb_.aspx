        ...
        <div class="table-data-maincontainer">
          <div class="table-container table-container-search"> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                <div class="content-grid mdl-grid">
                  ...
                  <div  class="mdl-cell mdl-cell--7-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text">
                    ...
                    <span id="ro-CenPH_DSPFMT1_CRPHNB_new" style="display: none;"></span> </span></div>
                </div>
              </div>
              <!-- 6 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--5-col" style="margin: 0;"> <span class="form-label">Work:</span> </div>
                  <div  class="mdl-cell mdl-cell--7-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text">
                    <input type="text" id="CenPH_DSPFMT1_CRWRKB_new" style="display: none;">
                    <span id="ro-CenPH_DSPFMT1_CRWRKB_new" style="display: none;"></span> </span> </div>
                </div>
              </div>
              <!-- 6 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                <div class="content-grid mdl-grid">
                  ...
                  <div  class="mdl-cell mdl-cell--7-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT1_CRNMEB_new"></span> </div>
                </div>
              </div>
              <!-- 6 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--5-col" style="margin: 0;"> <span class="form-label">D.O.B:</span> </div>
                  <div  class="mdl-cell mdl-cell--7-col" style="margin: 0;"><span data-upgraded=",MaterialTextfield" class="form-text">
                    <input class="editable-data" type="text" data-tb-index="2" id="ctl00$CenPH$DSPFMT1_DOB_lb_1B_new" size="15" readonly>
                    <i id="cust-reqesdate" class="material-icons calender-icon page-icons editable-data"></i> <span class="form-text vertical-top ro-data" id="ro-cust-birth"></span> </span> </div>
                </div>
              </div>
              <!-- 6 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--5-col" style="margin: 0;"> <span class="form-label">Age:</span></div>
                  <div  class="mdl-cell mdl-cell--7-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT1_CRAGEB_new"></span> </div>
                </div>
              </div>
              <!-- 6 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--5-col" style="margin: 0;"><span class="form-label">Co-Debtor D.O.B:</span> </div>
                  <div  class="mdl-cell mdl-cell--7-col" style="margin: 0;"><span data-upgraded=",MaterialTextfield" class="form-text">
                    <input class="editable-data" type="text" data-tb-index="5" id="ctl00$CenPH$DSPFMT1_DOB_lb_2B_new" size="15" readonly>
                    <i id="cust-reqesdate1" class="material-icons calender-icon page-icons editable-data"></i> <span class="form-text vertical-top ro-data" id="ro-cust-birth"></span></span> </div>
                </div>
              </div>
              <!-- 6 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--5-col" style="margin: 0;"><span class="form-label">Co-Debtor Age:</span></div>
                  <div  class="mdl-cell mdl-cell--7-col" style="margin: 0;"> <span class="form-text" data-upgraded=",MaterialTextfield" id="CenPH_DSPFMT1_CRAGSB_new"></span> </div>
                </div>
              </div>
              <!-- 6 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--6-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--5-col" style="margin: 0;"><span class="form-label">Address 1:</span> </div>
                  <div  class="mdl-cell mdl-cell--7-col" style="margin: 0;"><span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT1_CRAD1B_new"></span> </div>
                </div>
              </div>
              <!-- 6 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--6-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--5-col" style="margin: 0;"> <span class="form-label">Address 2:</span> </div>
                  <div  class="mdl-cell mdl-cell--7-col" style="margin: 0;"><span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT1_CRAD2B_new"></span> </div>
                </div>
              </div>
              <!-- 6 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--6-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--5-col" style="margin: 0;"> <span class="form-label">City/State:</span></div>
                  <div  class="mdl-cell mdl-cell--7-col" style="margin: 0;"><span data-upgraded=",MaterialTextfield" class="form-text"><span id="CenPH_DSPFMT1_CRCTYB_new"></span> <span style="margin-left: 10px;" id="CenPH_DSPFMT1_CRSTAB_new"></span></span> </div>
                </div>
              </div>
              <!-- 6 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--6-col">
                <div class="content-grid mdl-grid">
                  ...
                  <div  class="mdl-cell mdl-cell--7-col" style="margin: 0;"><span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT1_CRZIPB_new"></span> </div>
                </div>
              </div>
              <!-- 6 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--6-col">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--5-col mdl-cell--3-col-tablet" style="margin:0"> <span class="form-label">Months:</span> </div>
                  <div class="mdl-cell mdl-cell--2-col mdl-cell--2-col-tablet" style="margin:0"> <span class="form-text" data-upgraded=",MaterialTextfield">
                    <input type="text" data-tb-index="6" class="mdl-textfield__input" size="12" id="CenPH_DSPFMT1_CRMTHB_new" maxlength="2" />
                    </span> </div>
                  <div style="margin:0 0 0 20px;" class="mdl-cell mdl-cell--1-col mdl-cell--1-col-tablet"> <span class="form-label">State:</span> </div>
                  <div style="margin:0" class="mdl-cell mdl-cell--3-col mdl-cell--2-col-tablet"> <span class="form-text" data-upgraded=",MaterialTextfield" id="CenPH_DSPFMT1_CRSCDB_new"></span> </div>
                </div>
              </div>
              <!-- 6 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--5-col" style="margin: 0;"><span class="form-label">Purchase Amount:</span> </div>
                  <div  class="mdl-cell mdl-cell--7-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT1_CRPCHB_new"></span> </div>
                </div>
              </div>
              <!-- 6 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--6-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--5-col" style="margin: 0;"><span class="form-label">Down Payment:</span> </div>
                  <div  class="mdl-cell mdl-cell--7-col" style="margin: 0;"><span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT1_CRDWNB_new"></span> </div>
                </div>
              </div>
              <!-- 6 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--5-col" style="margin: 0;"><span class="form-label">Add-on Amount:</span> </div>
                  <div  class="mdl-cell mdl-cell--7-col" style="margin: 0;"><span data-upgraded=",MaterialTextfield" class="form-text">
                    <input type="text" data-tb-index="7" class="mdl-textfield__input" size="12" id="CenPH_DSPFMT1_ADDON_usd_new" maxlength="7" />
                    </span> </div>
                </div>
              </div>
              <!-- 6 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--5-col" style="margin: 0;"><span class="form-label">From Contract #:</span></div>
                  <div  class="mdl-cell mdl-cell--7-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text">
                    <input type="text" data-tb-index="8" id="CenPH_DSPFMT1_FRCNTC_new" maxlength="10">
                    </input>
                    </span> </div>
                </div>
              </div>
            ...
            <div class="content-grid mdl-grid"> 
              <!-- 12 col starts here -->
              <div class="mdl-cell mdl-cell--12-col"><span class="form-label summary-table-title">Insurance:</span></div>
              <!-- 12 col ends here --> 
              
            </div>
            <div style="padding:0" class="content-grid mdl-grid"> 
              <!-- 6 col starts here -->
              <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                <div class="content-grid mdl-grid">
                  <div style="margin:0" class="mdl-cell mdl-cell--5-col"><span class="form-label">Life:</span></div>
                  <div style="margin:0" class="mdl-cell mdl-cell--7-col"> <span class="form-text" data-upgraded=",MaterialTextfield">
                    <select id="CenPH_DSPFMT1_CRLIFB_new" data-tb-index="9">
                      <option value=" "> </option>
              ...
              <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                <div class="content-grid mdl-grid">
                  <div style="margin:0" class="mdl-cell mdl-cell--5-col"> <span class="form-label">Accidental &amp; Health:</span> </div>
                  <div style="margin:0" class="mdl-cell mdl-cell--7-col"><span class="form-text" data-upgraded=",MaterialTextfield">
                    <select id="CenPH_DSPFMT1_CRACHB_new" data-tb-index="10">
                      <option value=" "> </option>
                      <option value="0"> 0 </option>
                      <option selected="selected" value="1"> 1 </option>
                    </select>
            ...
            <div style="padding:0" class="content-grid mdl-grid"> 
              ...
              <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                <div class="content-grid mdl-grid">
                  <div style="margin:0" class="mdl-cell mdl-cell--5-col"><span class="form-label">Property:</span></div>
                  <div style="margin:0" class="mdl-cell mdl-cell--7-col"> <span class="form-text" data-upgraded=",MaterialTextfield">
                    <select id="CenPH_DSPFMT1_CRPRPB_new" data-tb-index="11" style="display: none;">
                      <option value=" "> </option>
                      <option value="0"> 0 </option>
                      <option selected="selected" value="1"> 1 </option>
                    </select>
                    </span> <span class="form-text" data-upgraded=",MaterialTextfield" id="CenPH_DSPFMT1_CRPRPB_new_ro" style="display: none;"></span> </div>
                </div>
              </div>
              <!-- 6 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                <div class="content-grid mdl-grid">
                  <div style="margin:0" class="mdl-cell mdl-cell--5-col"> <span class="form-label">Unemployment:</span> </div>
                  <div style="margin:0" class="mdl-cell mdl-cell--7-col"> <span class="form-text" data-upgraded=",MaterialTextfield">
                    <select id="CenPH_DSPFMT1_CRUEMB_new" data-tb-index="12">
                      <option value=" "> </option>
                      <option value="0"> 0 </option>
                      <option selected="selected" value="1"> 1 </option>
                    </select>
            ...
            <div class="button-container">
              <div class="content-grid mdl-grid">
                ...
                <div class="mdl-cell mdl-cell--2-col mdl-cell--5-col-desktop mdl-cell--2-col-tablet pull-right"> 
<span data-tb-index="17" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="Menu">Menu</span>
                <span data-tb-index="17" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="next">next</span> </div>
              </div>
            </div>
          </div>
        </div>
  ...
  <main class="mdl-layout__content" id="second-view" style="display: none;margin-bottom: 35px;">
    <section class="time-date">
      <div class="content-grid mdl-grid">
        ...
        <div class="mdl-cell mdl-cell--4-col pull-right"> 
          <!-- Navigation --> 
          <i class="material-icons md-15 md-light computer-icon"></i> <span class="date-time-txt">CR1002RI</span> <i class="material-icons md-15 md-light date-icon"></i> <span class="date-time-txt" name="date" id="date2"></span> <i class="material-icons md-15 md-light time-icon"></i> <span class="date-time-txt" name="time" id="time2"></span> </div>
      </div>
    </section>
    <section class="progress-bar">
      <div class="progress-bar-wrapper">
        ...
        <div class="table-data-maincontainer">
          <div class="table-container table-container-search"> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  ...
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRPHNB_new"></span></div>
                </div>
              </div>
              <!-- 4 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">Work:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"><span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRWRKB_new"></span> </div>
                </div>
              </div>
              <!--4 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">Name:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRNMEB_new"></span></div>
                </div>
              </div>
              <!-- 4 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  ...
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"><span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRAGEB_new"></span> </div>
                </div>
              </div>
              <!--4 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">Co-Debtor:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"><span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRSPNB_new"></span></div>
                </div>
              </div>
              <!-- 4 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">Co-Debtor Age:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-text" data-upgraded=",MaterialTextfield" id="CenPH_DSPFMT2_CRAGSB_new"></span> </div>
                </div>
              </div>
              <!--4 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">Address 1:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRAD1B_new"></span></div>
                </div>
              </div>
              <!-- 4 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">Address 2:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"><span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRAD2B_new"></span></div>
                </div>
              </div>
              <!-- 4 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">City/State:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text"><span id="CenPH_DSPFMT2_CRCTYB_new"></span> <span style="margin-left: 10px;" id="CenPH_DSPFMT2_CRSTAB_new"></span></span></div>
                </div>
              </div>
              <!-- 4 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">Zip Code:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"><span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRZIPB_new"></span></div>
                </div>
              </div>
              <!--4 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">Months:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRMTHB_new"></span></div>
                </div>
              </div>
              <!-- 4 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  ...
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"><span class="form-text" data-upgraded=",MaterialTextfield" id="CenPH_DSPFMT2_CRSCDB_new"></span></div>
                </div>
              </div>
              <!--4 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  ...
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRPCHB_new"></span></div>
                </div>
              </div>
              <!-- 4 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  ...
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRDWNB_new"></span> </div>
                </div>
              </div>
              <!-- 4 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">Add-on Amount:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_ADDON_usd_new"></span> </div>
                </div>
              </div>
              <!-- 4 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">From Contract #:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_FRCNTC_new"></span> </div>
                </div>
              </div>
              <!--4 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">First Payment Due:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="ctl00$CenPH$DSPFMT2_CRFPYB_new"></span></div>
                </div>
              </div>
              <!-- 4 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">Deferred Date:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="ctl00$CenPH$DSPFMT2_DFRPMT_new"></span></div>
                </div>
              </div>
              <!--4 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">Final Payment:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_PRDS_usd_new"></span> </div>
                </div>
              </div>
              <!--4 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">Monthly Payment:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRMPYO_new"></span> </div>
                </div>
              </div>
              <!-- 4 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">Total of Payments:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRTOTO_new"></span></div>
                </div>
              </div>
              <!--4 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">Amount Financed:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRBUYO_new"></span> </div>
                </div>
              </div>
              <!-- 4 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">Interest Amount:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRINTO_new"></span></div>
                </div>
              </div>
              <!--4 col ends here --> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">Loan Orig. Fee:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRFILO_new"></span></div>
                </div>
              </div>
              <!-- 4 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span class="form-label">A.P.R:</span> </div>
                  <div  class="mdl-cell mdl-cell--6-col" style="margin: 0;"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH_DSPFMT2_CRAPRO_new"></span></div>
                </div>
              </div>
              <!--4 col ends here --> 
            ...
            <hr style="border-color: #c6c6c6; margin: 5px 15px; height: 1px;">
            <div class="content-grid mdl-grid">
              <div style="margin-top: 0;" class="mdl-cell mdl-cell--12-col"><span class="form-label summary-table-title">Insurance:</span></div>
            </div>
            <div style="padding:0" class="content-grid mdl-grid"> 
              <!-- 4 col starts here -->
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  ...
                  <div class="mdl-cell mdl-cell--6-col" style="margin:0"> <span class="form-text" data-upgraded=",MaterialTextfield" id="CenPH_DSPFMT2_CRLF_usd_O_new"></span> </div>
                </div>
              </div>
              <!-- 4 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--6-col" style="margin:0"> <span class="form-label">Disability:</span> </div>
                  <div class="mdl-cell mdl-cell--6-col" style="margin:0"><span class="form-text" data-upgraded=",MaterialTextfield" id="CenPH_DSPFMT2_CRAH_usd_O_new"></span></div>
                </div>
              </div>
              <!-- 4 col ends here --> 
            ...
            <div style="padding:0" class="content-grid mdl-grid"> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--6-col" style="margin:0"><span class="form-label">Unemployment:</span> </div>
                  <div class="mdl-cell mdl-cell--6-col" style="margin:0"><span class="form-text" data-upgraded=",MaterialTextfield" id="CenPH_DSPFMT2_CRUE_usd_O_new"></span> </div>
                </div>
              </div>
              <!-- 4 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  ...
                  <div class="mdl-cell mdl-cell--6-col" style="margin:0"> <span class="form-text" data-upgraded=",MaterialTextfield" id="CenPH_DSPFMT2_CRPR_usd_O_new"></span> </div>
                </div>
              </div>
              <!-- 4 col ends here --> 
              ...
              <div class="mdl-cell mdl-cell--4-col">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--6-col" style="margin:0"><span class="form-label">On:</span> </div>
                  <div class="mdl-cell mdl-cell--6-col" style="margin:0"> <span class="form-text" data-upgraded=",MaterialTextfield" id="ctl00$CenPH$DSPFMT2_CRLPYO_new"></span> </div>
                </div>
              </div>
              <!-- 4 col ends here --> 
