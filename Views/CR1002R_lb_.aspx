    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            if ($("#CenPH_DSPFMT1_CRPHNB").length > 0) {
                ...
                $("#ctl00\\$CenPH\\$DSPFMT1_DOB_lb_1B_new").datepicker({ changeMonth: true, changeYear: true, dateFormat: 'mm/dd/yy', maxDate: new Date, minDate: new Date(1800, 1, 1), yearRange: "-100:+0" });
