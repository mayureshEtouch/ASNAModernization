  <%@ Page Language="C#" AutoEventWireup="true"  CodeFile="IONKDFR_lb_.aspx.cs" Inherits="conns.IONKDFR_lb_Form"  MasterPageFile="~/Themes/Current/MasterPage.master" %>
  <%@ Register  TagPrefix="mdf" Assembly="ASNA.Monarch.WebDspF, Version=12.0.49.0, Culture=neutral, PublicKeyToken=71de708db13b26d3" Namespace="ASNA.Monarch.WebDspF" %>

      <asp:Content ContentPlaceHolderID="HeaderPH" runat="Server" >
          <%-- Migrated on 2/27/2017 at 4:23 PM by ASNA Monarch(R) Wings version 7.0.58.0 --%>
          <%-- Legacy location: library ASNATRACK, file qddssrc, member IONKDFR# --%>
      ...
      <asp:Content ID="FileContent1" runat="server" ContentPlaceHolderID="FKeyPH">
          <div id="Div0">
              ...
              <mdf:ddsfile id="IONKDFR_lb_Control" runat="server" 
      ...
      <asp:Content ID="FileContent2" runat="server" ContentPlaceHolderID="CenPH">
              ...
              <section class="time-date">
                  <div class="content-grid mdl-grid">
                      <div class="mdl-cell mdl-cell--8-col">
                          <!-- Title -->
                          <span class="heading-h1">OE: DSP SKU by Model-IAP</span>
                      </div>
                      <div class="mdl-cell mdl-cell--4-col pull-right">
                          <!-- Navigation -->
              <i class="material-icons md-15 md-light computer-icon"></i> <span class="date-time-txt">IONKDFR</span>
                          ...
                          <div class="content-grid mdl-grid">
                            <div class="mdl-cell mdl-cell--2-col mdl-cell--2-col-tablet" style="width: 120px;">
                              ...
                              <div class="mdl-cell mdl-cell--10-col mdl-cell--6-col-tablet">
                                <input type="text" id="number" class="mdl-textfield__input" maxlength="20">
                              </div>
                          </div>
                        </div>
              ...
              <div class="table-data-wrapper">
                <div class="table-data-maincontainer">
                  <div class="table-container" style="overflow-y: visible;">
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" id="modelDetails" class="mdl-data-table mdl-js-data-table mdl-shadow--2dp navigateable" >
                     <thead>
                      <tr data-myval="">
        ...
        <%--  OE: DSP SKU by Model-IAP  Display file                                                                           --%>
        <%--  CRTDSPF                                                                                                          --%>
        <%--  RSTDSP(*YES)                                                                                                     --%>
        <%--  MEMBER-ID: IONKDFR#                                                                                              --%>
        <%--                                                                                                                   --%>
      ...
      <asp:Content ContentPlaceHolderID="PageScriptPH" runat="server" >
          ...
          <script type="text/javascript">
             var copyToAndFrom = {
              ...
              "inputFields": {
                "CenPH__lb_SFLCTL__lb_2AXTX":"number",
              }
            }
