...
<main class="mdl-layout__content">
  ...
  <section class="table-data-content-container mrgnTp16" id="instruction">
   <div class="table-data-wrapper">
     <div class="table-data-maincontainer">
       <div class="table-container table-container-search">
         ...
         <div class="content-grid mdl-grid" style="padding:0">
           ...
           <div class="mdl-cell mdl-cell--12-col mdl-cell mdl-cell--8-col-tablet">
             <ul class='mdl-list'>
               ...
               <li class="mdl-list__item info-text" id="CenPH__lb_SFLCTL__lb_CAHNA_new"></li>
               <li class="mdl-list__item info-text" id="CenPH__lb_SFLCTL__lb_CAINA_new"></li>
               <li class="mdl-list__item info-text" id="CenPH__lb_SFLCTL__lb_CAJNA_new"></li>
               <li class="mdl-list__item info-text" id="CenPH__lb_SFLCTL__lb_CAKNA_new"></li>
               <li class="mdl-list__item info-text" id="CenPH__lb_SFLCTL__lb_CALNA_new"></li>
