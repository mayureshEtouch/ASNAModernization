               ...
               <div class="table-container table-container-search">
                 ...
                 <div class="content-grid mdl-grid" style="padding:0">
                   ...
                   <div class="mdl-cell mdl-cell--12-col mdl-cell mdl-cell--8-col-tablet">
                     <span data-upgraded=",MaterialTextfield" class="info-text" id="CenPH__lb_SFLCTL__lb_CAHNA_new"></span> <br />
                     <span data-upgraded=",MaterialTextfield" class="info-text" id="CenPH__lb_SFLCTL__lb_CAINA_new"></span> <br />
                     <span data-upgraded=",MaterialTextfield" class="info-text" id="CenPH__lb_SFLCTL__lb_CAJNA_new"></span> <br />
                     <span data-upgraded=",MaterialTextfield" class="info-text" id="CenPH__lb_SFLCTL__lb_CAKNA_new"></span> <br />
                     <span data-upgraded=",MaterialTextfield" class="info-text" id="CenPH__lb_SFLCTL__lb_CALNA_new"></span> 
                   </div>
                   <!-- 6 col ends here -->
                 </div>
                 <!-- content-grid mdl-grid ends here -->
