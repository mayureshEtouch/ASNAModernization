        ...
        <div class="table-data-maincontainer">
          <div class="table-container table-container-search"> 
            ...
            <div class="content-grid mdl-grid" style="padding:0"> 
              ...
              <div style="border-bottom: #c6c6c6 1px solid;" class="mdl-cell mdl-cell--12-col mdl-cell--8-col-tablet"></div>
        ...
        <div class="table-data-maincontainer">
          <div class="table-container table-container-search"> 
            ...
            <div class="button-container">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--12-col mdl-cell--8-col-tablet"> <span class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="exit">Exit</span> </div>
              </div>
            </div>
          </div>
        </div>
