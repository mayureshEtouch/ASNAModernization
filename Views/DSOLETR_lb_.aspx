                    ...
                    <div class="content-grid mdl-grid" style="padding:0">
                      ...
                      <div class="mdl-cell mdl-cell--6-col  mdl-cell--4-col-tablet">
                        <div class="content-grid mdl-grid">
                          ...
                          <div  class="mdl-cell mdl-cell--8-col  mdl-cell--4-col-tablet" style="margin: 0"> <span data-upgraded=",MaterialTextfield" class="form-text" id="CenPH__lb_SFLCTL__lb_1AACD_new"></span> </div>
                        </div>
                      </div>
                      <!-- 6 col ends here -->      
          ...
          <script type="text/javascript">
            var copyToAndFrom = {
              "displayOnlyFields": {
				...
				"CenPH__lb_SFLCTL__lb_CIYS_lb_": "CenPH__lb_SFLCTL__lb_CIYS_lb__new",
