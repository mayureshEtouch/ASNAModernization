<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="CSARD1R_lb_.aspx.cs" Inherits="CONNS.CSARD1R_lb_Form"  MasterPageFile="~/Themes/Current/MasterPage.master" %>
<%@ Register  TagPrefix="mdf" Assembly="ASNA.Monarch.WebDspF, Version=14.0.36.0, Culture=neutral, PublicKeyToken=71de708db13b26d3" Namespace="ASNA.Monarch.WebDspF" %>

    <asp:Content ContentPlaceHolderID="HeaderPH" runat="Server" >
        <%-- Migrated on 2/1/2018 at 11:31 AM by ASNA Monarch(R) Wings version 8.0.40.0 --%>
        <%-- Legacy location: library ASNATRACK, file QDDSSRC, member CSARD1R# --%>
    ...
    <asp:Content ID="FileContent1" runat="server" ContentPlaceHolderID="FKeyPH">
        <div id="Div0">
            ...
            <mdf:ddsfile id="CSARD1R_lb_Control" runat="server" 
    ...
    <section class="time-date">
      <div class="content-grid mdl-grid">
        <div class="mdl-cell mdl-cell--8-col"> 
          <!-- Title --> 
          <span class="heading-h1">Intellicheck - Application Detail</span> </div>
        <div class="mdl-cell mdl-cell--4-col pull-right"> 
          <!-- Navigation --> 
          <i class="material-icons md-15 md-light computer-icon"></i> <span class="date-time-txt">CSARD1R</span> <i class="material-icons md-15 md-light date-icon"></i> <span class="date-time-txt" name="date" id="date"></span> <i class="material-icons md-15 md-light time-icon"></i> &nbsp;<span class="date-time-txt" name="time" id="time"></span> </div>
      </div>
    </section>
    <section class="table-data-content-container spacer-container-bottom mrgnTp16">
                    ...
                    <div style="overflow: auto;" class="table-container">
                      <table cellspacing="0" cellpadding="0" border="0" class="normal-table" id="" data-upgraded=",MaterialDataTable">
                        <thead>
                          ...
                          <tr>
                            <td align=""><span class="form-text" id="CenPH__lb_RCDDTL1__lb_1ITNB_new">2367</span></td>
                            <td><span class="form-text" id="CenPH__lb_RCDDTL1__lb_1K0ST_new">P</span></td>
                            <td><span class="form-text" id="CenPH__lb_RCDDTL1__lb_1AICO_new">CCC</span></td>
                            <td><span class="form-text" id="CenPH__lb_RCDDTL1__lb_1AHCO_new">I/L</span></td>
                            <td><span class="form-text" id="CenPH__lb_RCDDTL1__lb_1A9CO_new">GR3</span></td>
                            <td align=""><span class="form-text" id="CenPH__lb_RCDDTL1__lb_1BANB_new">3066</span></td>
                            <td><span class="form-text" id="CenPH__lb_RCDDTL1__lb_1K1ST_new">R</span></td>
                            <td><span class="form-text" id="CenPH__lb_RCDDTL1__lb_1ABCD_new">CON</span></td>
                            <td align=""><span class="form-text" id="CenPH__lb_RCDDTL1__lb_1AACD_new">073</span></td>
                            <td><span class="form-text" id="CenPH__lb_RCDDTL1__lb_DA0TX_new">Test</span></td>
                          </tr>
                        </thead>
                      </table>
                    </div>
          ...
          <div class="table-container table-container-search"> 
            ...
            <div class="content-grid mdl-grid"> 
              ...
              <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet" style="padding:0">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-label">Sold To:</span> </div>
                  <div class="mdl-cell mdl-cell--7-col mdl-cell--4-col-tablet" style="margin:0"> <span style="display: inline-block;" id="CenPH__lb_RCDDTL1__lb_DALTX_new">Clooney, George</span><br />
                    <span style="display: inline-block;" id="CenPH__lb_RCDDTL1__lb_DBNTX_new">test</span><br />
                    <span style="display: inline-block;" id="CenPH__lb_RCDDTL1__lb_DBOTX_new">Beaumont</span><br />
                    <span style="display: inline-block;" id="CenPH__lb_RCDDTL1__lb_DBPTX_new"></span> <span style="display: inline-block;" id="CenPH__lb_RCDDTL1__lb_DBLTX_new">TX</span>, <span style="display: inline-block;" id="CenPH__lb_RCDDTL1__lb_DUSTX_new">77703</span> </div>
                </div>
              </div>
              <!-- col ends here --> 
              <!-- col starts here -->
              <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_DPCN_lb__new_div">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-label">EPD:</span> </div>
                  <div class="mdl-cell mdl-cell--7-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_DPCN_lb__new"> 999 Declined</span> </div>
                </div>
              </div>
              <!-- col ends here --> 
              <!-- col starts here -->
              <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_DZ9TX_new_div">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--3-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-label">CB Level:</span> </div>
                  <div class="mdl-cell mdl-cell--9-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_DZ9TX_new" style="padding-right:5px;">000 </span> (<span class="form-text" id="CenPH__lb_RCDDTL1__lb_DESN_lb__new">430</span>) <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1AMCO_new" style="padding-left:5px;">EQF </span> <span class="form-text" id="CenPH__lb_RCDDTL1_V1C4DT_new" style="padding-left:5px;">01/31/2018 </span> </div>
                </div>
              </div>
              <!-- col ends here --> 
            </div>
            ...
            <div class="content-grid mdl-grid"> 
              <!-- col starts here -->
              <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_DPRNB_new_div">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-label">Cell:</span> </div>
                  <div class="mdl-cell mdl-cell--7-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_DPRNB_new">767/676-7676</span> </div>
                </div>
              </div>
              <!-- col ends here --> 
              
              <!-- col starts here -->
              <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_1A4NB_new_div3">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--12-col mdl-cell mdl-cell--8-col-tablet" style="margin:0">
                    <table cellspacing="0" cellpadding="0" border="0" class="normal-table" id="" data-upgraded=",MaterialDataTable">
                      <thead>
                        ...
                        <tr>
                          <td><span class="form-text" id="CenPH__lb_RCDDTL1__lb_DOKST_new">00</span><br />
                            <span class="form-text" id="CenPH__lb_RCDDTL1__lb_DOMST_new">00</span></td>
                          <td><span class="form-text" id="CenPH__lb_RCDDTL1__lb_DOOST_new">00</span><br />
                            <span class="form-text" id="CenPH__lb_RCDDTL1__lb_DOPST_new">00</span><br /></td>
                          <td><span class="form-text" id="CenPH__lb_RCDDTL1_VDD2DT_new">00</span><br />
                            <span class="form-text" id="CenPH__lb_RCDDTL1_VDD3DT_new">00</span></td>
                        </tr>
                      </thead>
                    </table>
                  </div>
            ...
            <div class="content-grid mdl-grid"> 
              ...
              <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet" style="padding:0">
                <div class="content-grid mdl-grid">
                  ...
                  <div class="mdl-cell mdl-cell--7-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_DD1NB_new">767/676-7676</span> </div>
                </div>
              </div>
              <!-- col ends here --> 
              <!-- col starts here -->
            ...
            <div class="content-grid mdl-grid"> 
              <!-- col starts here -->
              <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_DUNTX_new_div">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-label">Employer:</span> </div>
                  <div class="mdl-cell mdl-cell--7-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_DUNTX_new">Unemployed</span> </div>
                </div>
              </div>              
              <!-- col ends here --> 
            </div>
      ...
      <div class="table-data-wrapper mrgnTp16">
        <div class="table-data-maincontainer">
          <div class="table-container table-container-search"> 
            ...
            <div class="content-grid mdl-grid"> 
              <!-- col starts here -->
              <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet" id="CenPH__lb_RCDDTL1__lb_1GXVA_new_div" style="padding:0">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-tablet"  style="margin:0"> <span class="form-label">Current Obligation:</span> </div>
                  <div class="mdl-cell mdl-cell--7-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1GXVA_new"></span> </div>
                </div>
              </div>
              <!-- col ends here --> 
              <!-- col starts here -->
              <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet" id="CenPH__lb_RCDDTL1__lb_1LQST_new_div" style="padding:0">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-label">Auto=</span> </div>
                  <div class="mdl-cell mdl-cell--7-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1LQST_new"></span> </div>
                </div>
              </div>
              <!-- col ends here --> 
              <!-- col starts here -->
              <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet" id="CenPH__lb_RCDDTL1__lb_1LRST_new_div" style="padding:0">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-label">PD=</span> </div>
                  <div class="mdl-cell mdl-cell--7-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1LRST_new"></span> </div>
                </div>
              </div>
              <!-- col ends here --> 
              <!-- col starts here -->
              <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet" id="CenPH__lb_RCDDTL1__lb_DHHVA_new_div" style="padding:0">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-label">Credit Available:</span> </div>
                  <div class="mdl-cell mdl-cell--7-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_DHHVA_new"></span> </div>
                </div>
              </div>
              <!-- col ends here --> 
            </div>
            ...
            <div class="content-grid mdl-grid"> 
              <!-- col starts here -->
              <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet" id="CenPH__lb_RCDDTL1__lb_1ALCO_new_div" style="padding:0">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-tablet"  style="margin:0"> <span class="form-label">Prom:</span> </div>
                  <div class="mdl-cell mdl-cell--7-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1ALCO_new"></span> </div>
                </div>
              </div>
              <!-- col ends here --> 
              <!-- col starts here -->
              <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet" id="p_doller_div" style="padding:0">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-label">P$:</span> </div>
                  <div class="mdl-cell mdl-cell--7-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1G4VA_new"></span> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1ACCT_new"></span> </div>
                </div>
              </div>
              <!-- col ends here --> 
              <!-- col starts here -->
              <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet" id="CenPH__lb_RCDDTL1__lb_DHBVA_new_div" style="padding:0">
                <div class="content-grid mdl-grid">
                  <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-label">Required Down:</span> </div>
                  <div class="mdl-cell mdl-cell--7-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_DHBVA_new"></span> </div>
                </div>
              </div>
              <!-- col ends here --> 
              <!-- col starts here -->
              <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet" id="CenPH__lb_RCDDTL1__lb_DHHVA_new_div" style="padding:0"> </div>
              <!-- col ends here --> 
            </div>
            <!-- content-grid mdl-grid ends here --> 
      ...
      <div class="table-container table-container-search">
        <div class="content-grid mdl-grid" style="padding: 10px 0;"> 
          ...
          <div class="mdl-cell mdl-cell--12-col mdl-cell mdl-cell--8-col-tablet" style="margin:0 auto;">
            <div class="content-grid mdl-grid" style="padding:0 8px;">
              <div class="mdl-cell mdl-cell--8-col mdl-cell mdl-cell--4-col-tablet">
                <table cellspacing="0" cellpadding="0" border="0" class="normal-table" id="" data-upgraded=",MaterialDataTable">
                  <thead>
                    <tr>
      ...
      <div class="button-container">
        <div class="content-grid mdl-grid">
          <div class="mdl-cell mdl-cell--4-col mdl-cell--7-col-desktop"> <span class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="" event-data="F3">Previous</span> </div>
  ...
  <div id="modal1" class="simplePopup"></div>
    <!-- Modified HTML code ends here -->
      ...
      <%--  OE: INT Appl-Display      Display record(1 screen)                                                               --%>
      <%--  CRTDSPF                                                                                                          --%>
      <%--  RSTDSP(*YES)                                                                                                     --%>
      <%--  MEMBER-ID: CSARD1R#                                                                                              --%>
      <%--                                                                                                                   --%>
 ...
 />
            <mdf:DdsConstant id="DdsConstant3" runat="server" 
              ...
              Text="Intellicheck - Application KEY SCREEN" 
              CssClass="DdsConstant"
 />
 ...
 />
            <mdf:DdsConstant id="DdsConstant25" runat="server" 
              ...
              Text="Intellicheck - Application Detail" 
              CssClass="DdsConstant"
 />
 ...
 />
  ...
  var copyToAndFrom = {
    "displayOnlyFields": {
      ...
      "CenPH__lb_RCDDTL1__lb_DPCN_lb_+CenPH__lb_RCDDTL1__lb_DQ7XT":"CenPH__lb_RCDDTL1__lb_DPCN_lb__new",
