<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="CCJZE1R_lb_.aspx.cs" Inherits="conns.CCJZE1R_lb_Form"  MasterPageFile="~/Themes/Current/MasterPage.master" %>
  ...
  <!-- #Include virtual="~/Views/PopupHeader.aspx" -->
    ...
    <asp:Content ID="FileContent1" runat="server" ContentPlaceHolderID="FKeyPH">
        <div id="Div0">
            ...
            <mdf:ddsfile id="CCJZE1R_lb_Control" runat="server" 
...
<!-- Modified HTML code ends here -->
 ...
 />
            <mdf:DdsConstant id="DdsConstant2" runat="server" 
              ...
              Text="CA: E1W Cancel Appl KEY SCREEN" 
 ...
 />
          ...
          <mdf:DdsRecord id="_lb_RCDDTL1" runat="server" 
            style="position: relative; width: 504px; height: 120px" 
            Alias="#RCDDTL1"
            CssClass="DdsRecord"
            AttnKeys="F3 'Exit.' 03;F12 'Exit.' 12;Clear 'CLEAR.' 26;Help 'Help.' 25;"
            FuncKeys="F4 'Prompt.' 04;F5 'Reset.' 05;"
 ...
 />
            <mdf:DdsConstant id="DdsConstant3" runat="server" 
              ...
              CssClass="DdsConstant"
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_1K0ST" runat="server" style="position: absolute; left: 154px; top: 48px; width: 10px"
              CssClass="DdsCharField"
              Length="1" 
              Alias="#1K0ST" 
              Usage="OutputOnly" 
 ...
 />
            <mdf:DdsConstant id="DdsConstant6" runat="server" 
              ...
              CssClass="DdsConstant"
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_1A7CO" runat="server" style="position: absolute; left: 262px; top: 48px; width: 91px"
              CssClass="DdsCharField"
              Length="10" 
              Alias="#1A7CO" 
              Usage="OutputOnly" 
 ...
 />
            <mdf:DdsConstant id="DdsConstant8" runat="server" 
              ...
              CssClass="DdsConstant"
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_1AICO" runat="server" style="position: absolute; left: 469px; top: 48px; width: 28px"
              CssClass="DdsCharField"
              Length="3" 
              Alias="#1AICO" 
              Usage="OutputOnly" 
 ...
 />
            <mdf:DdsConstant id="DdsConstant4" runat="server" 
              ...
              CssClass="DdsConstant"
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_1ULTX" runat="server" style="position: absolute; left: 82px; top: 72px; width: 361px"
              CssClass="DdsCharField"
              Length="40" 
              Lower="True" 
              Alias="#1ULTX" 
            ...
            <mdf:DdsConstant id="DdsConstant5" runat="server" 
              ...
              CssClass="DdsConstant"
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_1BBCO" runat="server" style="position: absolute; left: 127px; top: 96px; width: 91px"
              CssClass="DdsCharField"
              Length="10" 
              Alias="#1BBCO" 
              Usage="Both" 
