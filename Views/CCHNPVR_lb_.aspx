...
<asp:Content ID="FileContent2" runat="server" ContentPlaceHolderID="CenPH">
                ...
                <div class="table-data-maincontainer">
                    <div class="table-container table-container-search">
                        ...
                        <div class="content-grid mdl-grid" style="padding: 0">
                            ...
                            <div class="mdl-cell mdl-cell--6-col">
                                <div class="content-grid mdl-grid">
                                    <div class="mdl-cell mdl-cell--2-col"><span class="form-label"></span> </div>
                                    <div class="mdl-cell mdl-cell--2-col">
                                        <span data-upgraded=",MaterialTextfield" class="form-text">
                                            </span>
                                    </div>
                                    <div class="mdl-cell mdl-cell--2-col" style=""><span class="form-label"></span> </div>
                                    <div class="mdl-cell mdl-cell--4-col" style="">
                ...
                <div class="table-data-maincontainer">
					...
					<div class="button-container">
                            <div class="content-grid mdl-grid">
								...
								<span class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="next" event-data="Enter" data-tb-index="32">next</span>
                                    <span class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="previous" data-tb-index="33" event-data="F9">Get Customer</span>
    ...
    <script type="text/javascript">
        var copyToAndFrom = {
            "displayOnlyFields": {
				...
				"CenPH__lb_RCDDTL1__lb_DTX30":"CenPH__lb_RCDDTL1__lb_DTX30_new"
 ...
 />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_DCJVA" runat="server" style="position: absolute; left: 550px; top: 264px; width: 91px"
              ...
              EditCode="J" 
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_DTX30" runat="server" style="position: absolute; left: 406px; top: 288px; width: 271px"
              CssClass="DdsCharField"
              Length="30" 
              Alias="#DTX30" 
              VisibleCondition="!( 78 )"
 ...
 />
            <mdf:DdsConstant id="DdsConstant4" runat="server" 
              style="position: absolute; left: 37px; top: 339px;"
              Text="Cat - Or Model No.       Qty    Value $    Maint $     Total $" 
              Color="Blue" 
              CssClass="DdsConstant"
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_1PRDC" runat="server" style="position: absolute; left: 37px; top: 384px; width: 28px"
              CssClass="DdsCharField"
              Length="3" 
              Alias="#1PRDC" 
              Usage="Both" 
              ...
              TabIndex="11"  />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_DA6TX" runat="server" style="position: absolute; left: 73px; top: 384px; width: 181px"
              CssClass="DdsCharField"
              Length="20" 
              Alias="#DA6TX" 
              Usage="Both" 
              ...
              TabIndex="12"  />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_1PRDQ" runat="server" style="position: absolute; left: 289px; top: 384px; width: 28px"
              CssClass="DdsDecField"
              Length="3" 
              Decimals="0" 
              LeftPad="Zeroes" 
              ...
              EditCode="4" 
              TabIndex="13"  />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_1GFVA" runat="server" style="position: absolute; left: 325px; top: 384px; width: 82px"
              CssClass="DdsDecField"
              Length="9" 
              Decimals="2" 
              LeftPad="Blanks" 
              ...
              EditCode="4" 
              TabIndex="14"  />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_1PRDM" runat="server" style="position: absolute; left: 424px; top: 384px; width: 82px"
              CssClass="DdsDecField"
              Length="9" 
              Decimals="2" 
              LeftPad="Blanks" 
              ...
              EditCode="4" 
              TabIndex="15"  />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_DEYVA" runat="server" style="position: absolute; left: 523px; top: 384px; width: 109px"
              CssClass="DdsDecField"
              Length="9" 
              Decimals="2" 
              Alias="#DEYVA" 
              ...
              EditCode="J" 
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_DAWCO" runat="server" style="position: absolute; left: 37px; top: 408px; width: 28px"
              CssClass="DdsCharField"
              Length="3" 
              Alias="#DAWCO" 
              Usage="Both" 
              ...
              TabIndex="16"  />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_DUPTX" runat="server" style="position: absolute; left: 73px; top: 408px; width: 181px"
              CssClass="DdsCharField"
              Length="20" 
              Alias="#DUPTX" 
              Usage="Both" 
              ...
              TabIndex="17"  />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_DI2NB" runat="server" style="position: absolute; left: 289px; top: 408px; width: 28px"
              CssClass="DdsDecField"
              Length="3" 
              Decimals="0" 
              LeftPad="Zeroes" 
              ...
              EditCode="4" 
              TabIndex="18"  />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_DGIVA" runat="server" style="position: absolute; left: 325px; top: 408px; width: 82px"
              CssClass="DdsDecField"
              Length="9" 
              Decimals="2" 
              LeftPad="Blanks" 
              ...
              EditCode="4" 
              TabIndex="19"  />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_DGLVA" runat="server" style="position: absolute; left: 424px; top: 408px; width: 82px"
              CssClass="DdsDecField"
              Length="9" 
              Decimals="2" 
              LeftPad="Blanks" 
              ...
              EditCode="4" 
              TabIndex="20"  />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_DGOVA" runat="server" style="position: absolute; left: 523px; top: 408px; width: 109px"
              CssClass="DdsDecField"
              Length="9" 
              Decimals="2" 
              Alias="#DGOVA" 
              ...
              EditCode="J" 
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_DAXCO" runat="server" style="position: absolute; left: 37px; top: 432px; width: 28px"
              CssClass="DdsCharField"
              Length="3" 
              Alias="#DAXCO" 
              Usage="Both" 
              ...
              TabIndex="21"  />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_DUQTX" runat="server" style="position: absolute; left: 73px; top: 432px; width: 181px"
              CssClass="DdsCharField"
              Length="20" 
              Alias="#DUQTX" 
              Usage="Both" 
              ...
              TabIndex="22"  />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_DI3NB" runat="server" style="position: absolute; left: 289px; top: 432px; width: 28px"
              CssClass="DdsDecField"
              Length="3" 
              Decimals="0" 
              LeftPad="Zeroes" 
              ...
              EditCode="4" 
              TabIndex="23"  />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_DGJVA" runat="server" style="position: absolute; left: 325px; top: 432px; width: 82px"
              CssClass="DdsDecField"
              Length="9" 
              Decimals="2" 
              LeftPad="Blanks" 
              ...
              EditCode="4" 
              TabIndex="24"  />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_DGMVA" runat="server" style="position: absolute; left: 424px; top: 432px; width: 82px"
              CssClass="DdsDecField"
              Length="9" 
              Decimals="2" 
              LeftPad="Blanks" 
              ...
              EditCode="4" 
              TabIndex="25"  />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_DGPVA" runat="server" style="position: absolute; left: 523px; top: 432px; width: 109px"
              CssClass="DdsDecField"
              Length="9" 
              Decimals="2" 
              Alias="#DGPVA" 
              ...
              EditCode="J" 
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_DAYCO" runat="server" style="position: absolute; left: 37px; top: 456px; width: 28px"
              CssClass="DdsCharField"
              Length="3" 
              Alias="#DAYCO" 
              Usage="Both" 
              ...
              TabIndex="26"  />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_DURTX" runat="server" style="position: absolute; left: 73px; top: 456px; width: 181px"
              CssClass="DdsCharField"
              Length="20" 
              Alias="#DURTX" 
              Usage="Both" 
              ...
              TabIndex="27"  />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_DI4NB" runat="server" style="position: absolute; left: 289px; top: 456px; width: 28px"
              CssClass="DdsDecField"
              Length="3" 
              Decimals="0" 
              LeftPad="Zeroes" 
              ...
              EditCode="4" 
              TabIndex="28"  />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_DGKVA" runat="server" style="position: absolute; left: 325px; top: 456px; width: 82px"
              CssClass="DdsDecField"
              Length="9" 
              Decimals="2" 
              LeftPad="Blanks" 
              ...
              EditCode="4" 
              TabIndex="29"  />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_DGNVA" runat="server" style="position: absolute; left: 424px; top: 456px; width: 82px"
              CssClass="DdsDecField"
              Length="9" 
              Decimals="2" 
              LeftPad="Blanks" 
              ...
              EditCode="4" 
              TabIndex="30"  />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_DGQVA" runat="server" style="position: absolute; left: 523px; top: 456px; width: 109px"
              CssClass="DdsDecField"
              Length="9" 
              Decimals="2" 
              Alias="#DGQVA" 
