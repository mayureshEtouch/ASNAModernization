...
<%@ Register  TagPrefix="mdf" Assembly="ASNA.Monarch.WebDspF, Version=14.0.36.0, Culture=neutral, PublicKeyToken=71de708db13b26d3" Namespace="ASNA.Monarch.WebDspF" %>
    ...
    <asp:Content ContentPlaceHolderID="HeaderPH" runat="Server" >
        <%-- Migrated on 11/3/2017 at 3:58 PM by ASNA Monarch(R) Wings version 8.0.40.0 --%>
        <%-- Legacy location: library ASNATRACK, file QDDSSRC, member DSHQDFR# --%>
                ...
                <section class="time-date">
                    <div class="content-grid mdl-grid">
                        ...
                        <div class="mdl-cell mdl-cell--4-col pull-right">
                            <!-- Navigation -->
                            <i class="material-icons md-15 md-light computer-icon"></i> <span class="date-time-txt">DSHQDFR</span> 
    ...
    <!-- Modified HTML code ends here -->
      ...
      <%-- =========================================================================                                         --%>
          <mdf:DdsSubfileControl id="_lb_SFLCTL" runat="server" 
            ...
            FuncKeys="F4 'Prompt.' 04;F7 'CF07.' 07;F8 'CF08.' 08;PageDown 'Next page.' 27 : !82;"
            SetOfInds="98 99 " 
            CommandKeyInd="29" 
            ClearRecords="80" 
            DisplayFields="!80" 
 ...
 />
            <mdf:DdsConstant id="DdsConstant15" runat="server" 
              ...
              Text="F3=Exit  F7=Select Completed Order  F8=Progressive Order  F12=Return" 
              CssClass="DdsConstant"
 />
          </mdf:DdsRecord >
