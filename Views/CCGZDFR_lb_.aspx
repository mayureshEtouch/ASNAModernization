...
<asp:Content ContentPlaceHolderID="HeaderPH" runat="Server">
    <%-- Migrated on 4/19/2016 at 8:49 PM by ASNA Monarch(R) Wings version 7.0.58.0 --%>
    <%-- Legacy location: library ASNA3SRC, file QDDSSRC, member CCGZDFR# --%>
</asp:Content>
        ...
        <mdf:DdsSubfileControl ID="_lb_SFLCTL" runat="server"
          ...
          <%--  Customer ID                                                                                                      --%>
                ...
                <mdf:DdsDecField ID="_lb_SFLRCD__lb_1C4NB" runat="server" Style="position: absolute; left: 730px; top: 0px; width: 19px"
                    ...
                    VirtualRowCol="9,78"
                    EditCode="Z" />
                <mdf:DdsCharField ID="_lb_SFLRCD__lb_1CSCD" runat="server" Style="position: absolute; left: 199px; top: 24px; width: 10px"
                    CssClass="DdsCharField"
                    Length="1"
                    Alias="#1CSCD"
                    Usage="OutputOnly"
