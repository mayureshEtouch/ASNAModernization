...
<%@ Register  TagPrefix="mdf" Assembly="ASNA.Monarch.WebDspF, Version=14.0.36.0, Culture=neutral, PublicKeyToken=71de708db13b26d3" Namespace="ASNA.Monarch.WebDspF" %>
    ...
    <asp:Content ContentPlaceHolderID="HeaderPH" runat="Server" >
        <%-- Migrated on 1/31/2017 at 3:31 PM by ASNA Monarch(R) Wings version 7.0.58.0 --%>
        <%-- Legacy location: library ASNATRACK, file qddssrc, member CCG0D1R# --%>
...
<main class="mdl-layout__content">
 ...
 />
            <mdf:DdsConstant id="DdsConstant26" runat="server" 
              style="position: absolute; left: 253px; top: 339px;"
              Text="Extensions" 
              VisibleCondition="!( 75 )"
              Color="Blue : !75" 
              CssClass="DdsConstant"
 />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_1C6NB" runat="server" style="position: absolute; left: 352px; top: 336px; width: 19px"
              CssClass="DdsDecField"
              Length="2" 
              Decimals="0" 
              Alias="#1C6NB" 
 ...
 />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_1BHDT" runat="server" style="position: absolute; left: 1px; top: 0px; width: 64px"
              ...
              Usage="Hidden" 
 />
            <mdf:DdsDecDateField id="_lb_RCDDTL1_V1BHDT" runat="server" style="position: absolute; left: 451px; top: 336px; width: 73px"
              CssClass="DdsDecDateField"
              Length="8" 
              DateFormat="USA" 
              DateSeparator="'/'" 
 ...
 />
            <mdf:DdsConstant id="DdsConstant42" runat="server" 
              ...
              CssClass="DdsConstant"
 />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_1C0NB" runat="server" style="position: absolute; left: 748px; top: 336px; width: 19px"
              CssClass="DdsDecField"
              Length="2" 
              Decimals="0" 
              Alias="#1C0NB" 
 ...
 />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_1C4NB" runat="server" style="position: absolute; left: 73px; top: 384px; width: 19px"
              ...
              EditCode="Z" 
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_DVNTX" runat="server" style="position: absolute; left: 109px; top: 384px; width: 109px"
              CssClass="DdsCharField"
              Length="12" 
              Alias="#DVNTX" 
              Usage="OutputOnly" 
 ...
 />
            <mdf:DdsConstant id="DdsConstant27" runat="server" 
              ...
              CssClass="DdsConstant"
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_1CCCD" runat="server" style="position: absolute; left: 316px; top: 384px; width: 19px"
              CssClass="DdsCharField"
              Length="2" 
              Alias="#1CCCD" 
              Usage="OutputOnly" 
              VirtualRowCol="17,32" 
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_DVOTX" runat="server" style="position: absolute; left: 109px; top: 408px; width: 109px"
              CssClass="DdsCharField"
              Length="12" 
              Alias="#DVOTX" 
              Usage="OutputOnly" 
 ...
 />
            <mdf:DdsConstant id="DdsConstant28" runat="server" 
              ...
              CssClass="DdsConstant"
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_1BDCD" runat="server" style="position: absolute; left: 316px; top: 408px; width: 37px"
              CssClass="DdsCharField"
              Length="4" 
              Alias="#1BDCD" 
              Usage="OutputOnly" 
