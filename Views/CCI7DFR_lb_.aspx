<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="CCI7DFR_lb_.aspx.cs" Inherits="conns.CCI7DFR_lb_Form"  MasterPageFile="~/Themes/Current/MasterPage.master" %>
<%@ Register  TagPrefix="mdf" Assembly="ASNA.Monarch.WebDspF, Version=12.0.48.0, Culture=neutral, PublicKeyToken=71de708db13b26d3" Namespace="ASNA.Monarch.WebDspF" %>

    <asp:Content ContentPlaceHolderID="HeaderPH" runat="Server" >
        <%-- Migrated on 7/6/2016 at 10:06 PM by ASNA Monarch(R) Wings version 7.0.58.0 --%>
        <%-- Legacy location: library ASNAPH4BK, file QDDSSRC, member CCI7DFR# --%>
    ...
    <asp:Content ID="FileContent1" runat="server" ContentPlaceHolderID="FKeyPH">
        <div id="Div0">
            ...
            <mdf:ddsfile id="CCI7DFR_lb_Control" runat="server" 
 ...
 />
            <mdf:DdsConstant id="DdsConstant7" runat="server" 
              ...
              Text="Credit Application Review - Location" 
              CssClass="DdsConstant"
 />
 ...
 />
            ...
            <mdf:DdsConstant id="DdsConstant1" runat="server" 
              ...
              Text="Option: 1=Ent Inv  2=Wrk  5=Dsp 6=SbmToRAC  7=Notes  8=Decision  9=Appeal" 
              Color="Blue" 
              CssClass="DdsConstant"
 />
 ...
 />
          ...
          <mdf:DdsRecord id="_lb_CMDTXT1" runat="server" 
            style="position: relative; width: 639px; height: 24px" 
            Alias="#CMDTXT1"
            CssClass="DdsRecord"
          >&nbsp;
          <%--  Command key text                                                                                     --%>
          <%-- =========================================================================                             --%>
            <mdf:DdsConstant id="DdsConstant15" runat="server" 
              ...
              Text="F3=Exit  F5=Refresh  F8=Search  F9=Enter Quote  F10=GE Apps  F11=All" 
              CssClass="DdsConstant"
 />
          </mdf:DdsRecord >
