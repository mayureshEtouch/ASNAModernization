    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var formatTable = function() {
                // Remove labels like 'Actl price', "Inst price"
                $("#tblOdrDtls tbody tr").each(function () {
                  var selectBox = '<td>' + '<select><option value="">Active</option>' + '<option value="4">Cancel</option>' + '</select>' + '</td>'
            ...
            generateTableAndApplyInfiniteScroll(
              "tblOdrDtls", "CenPH__lb_SFLRCD", "NONE", "submit-installation", dataMergeIndices, true, "", "", formatTable
            );

            var selectRow = function (row, value, event) {
