<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="CSAKDFR_lb_.aspx.cs" Inherits="CONNS.CSAKDFR_lb_Form"  MasterPageFile="~/Themes/Current/MasterPage.master" %>
<%@ Register  TagPrefix="mdf" Assembly="ASNA.Monarch.WebDspF, Version=14.0.36.0, Culture=neutral, PublicKeyToken=71de708db13b26d3" Namespace="ASNA.Monarch.WebDspF" %>

    <asp:Content ContentPlaceHolderID="HeaderPH" runat="Server" >
        <%-- Migrated on 1/25/2018 at 3:20 PM by ASNA Monarch(R) Wings version 8.0.40.0 --%>
        <%-- Legacy location: library ASNATRACK, file QDDSSRC, member CSAKDFR# --%>
    ...
    <asp:Content ID="FileContent1" runat="server" ContentPlaceHolderID="FKeyPH">
        <div id="Div0">
            ...
            <mdf:ddsfile id="CSAKDFR_lb_Control" runat="server" 
...
<div class="OverlayPopupBackground"></div>
            ...
            <section class="time-date">
                <div class="content-grid mdl-grid">
                    <div class="mdl-cell mdl-cell--8-col">
                        <!-- Title -->
                        <span class="heading-h1">Intellicheck Scan Review - Location</span>
                    </div>
                    <div class="mdl-cell mdl-cell--4-col pull-right">
                        <!-- Navigation -->
                        <i class="material-icons md-15 md-light computer-icon"></i> <span class="date-time-txt">CSAKDFR</span>
    ...
    <section class="add-item">
                ...
                <span class="icon-txt notes-model">Notes</span><i class="material-icons md-15 md-light notes-icon"></i>
                <span class="icon-txt Intellicheck-model">Intellicheck</span><i class="material-icons md-15 md-light intellicheck-icon"></i>
              </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-data-wrapper">
                    <div class="table-data-maincontainer">
                        <div style="overflow: auto;" class="table-container">
                            <div>               
                <table cellspacing="0" cellpadding="0" border="0" class="mdl-data-table mdl-js-data-table mdl-shadow--2dp navigateable is-upgraded" id="tblreviewIntellicheck" data-upgraded=",MaterialDataTable">
                 <thead>
                          <tr>
                            <th>Code</th>
...
<!-- Modified HTML code ends here -->
      ...
      <%--  CA: DSP All Appl for IC   Display file                                                                           --%>
      <%--  CRTDSPF                                                                                                          --%>
      <%--  RSTDSP(*YES)                                                                                                     --%>
      <%--  MEMBER-ID: CSAKDFR#                                                                                              --%>
      <%--                                                                                                                   --%>
      ...
      <%-- =========================================================================                                         --%>
          <mdf:DdsSubfileControl id="_lb_SFLCTL" runat="server" 
            ...
            FuncKeys="F4 'Prompt.' 04;F5 'Reset.' 05;F8 'CF08.' 08;F9 'CF09.' 09;F11 'CF11.' 11;PageDown 'Next page.' 27 : !82;"
 ...
 />
            <mdf:DdsConstant id="DdsConstant8" runat="server" 
              ...
              Text="Intellicheck Scan Review - Location" 
              CssClass="DdsConstant"
 />
 ...
 />
            <mdf:DdsConstant id="DdsConstant14" runat="server" 
              ...
              CssClass="DdsConstant"
 />
            <mdf:DdsCharField id="_lb_SFLCTL__lb_CAGTX" runat="server" style="position: absolute; left: 1px; top: 0px; width: 37px"
              CssClass="DdsCharField"
              Length="4" 
              Alias="#CAGTX" 
              Usage="Hidden" 
 ...
 />
            <mdf:DdsCharField id="_lb_SFLCTL__lb_2ACCD" runat="server" style="position: absolute; left: 1px; top: 0px; width: 28px"
              ...
              Usage="Hidden" 
 />
            <mdf:DdsDecField id="_lb_SFLCTL__lb_2ITNB" runat="server" style="position: absolute; left: 91px; top: 48px; width: 82px"
              CssClass="DdsDecField"
              Length="9" 
              Decimals="0" 
              LeftPad="Zeroes" 
            ...
            <mdf:DdsConstant id="DdsConstant6" runat="server" 
              ...
              CssClass="DdsConstant"
 />
            <mdf:DdsCharField id="_lb_SFLCTL__lb_2AACD" runat="server" style="position: absolute; left: 217px; top: 48px; width: 28px"
              CssClass="DdsCharField"
              Length="3" 
              Alias="#2AACD" 
              Usage="OutputOnly" 
              VirtualRowCol="3,24" 
 />
            <mdf:DdsCharField id="_lb_SFLCTL__lb_CASTX" runat="server" style="position: absolute; left: 253px; top: 48px; width: 181px"
              CssClass="DdsCharField"
              Length="20" 
              Alias="#CASTX" 
              Usage="OutputOnly" 
              VirtualRowCol="3,28" 
 />
            <mdf:DdsCharField id="_lb_SFLCTL__lb_2AJCD" runat="server" style="position: absolute; left: 469px; top: 48px; width: 46px"
              CssClass="DdsCharField"
              Length="5" 
              Alias="#2AJCD" 
              Usage="Both" 
            ...
            <mdf:DdsConstant id="DdsConstant1" runat="server" 
              ...
              Text="Option: 5=Dsp 7=Notes I=Intellicheck" 
              Color="Blue" 
              CssClass="DdsConstant"
 />
 ...
 />
            <mdf:DdsConstant id="DdsConstant7" runat="server" 
              style="position: absolute; left: 208px; top: 147px;"
              Text="Date" 
              VisibleCondition="81"
              Color="DarkBlue" 
              CssClass="DdsConstant"
 ...
 />
          <mdf:DdsSubfile id="_lb_SFLRCD" runat="server" 
            style="position: absolute; left: 0px; top: 168px; width: 765px; height: 24px" 
            Alias="#SFLRCD"
 ...
 />
          ...
          <%-- =========================================================================                                         --%>
            <mdf:DdsConstant id="DdsConstant15" runat="server" 
              ...
              Text="F3=Exit  F5=Refresh  F8=Search  F11=All" 
              CssClass="DdsConstant"
 />
          </mdf:DdsRecord >
        ...
        $(document).ready(function () {
		  ...
		  $("#CenPH__lb_SFLCTL__lb_2ITNB_new, #CenPH__lb_SFLCTL__lb_2AJCD_new").attr('pattern', '[0-9]*');
             ...
             $(".display-model").click(function (event) {
                var row = $("#tblreviewIntellicheck tbody tr.selected");
                selectCusotmer(row, "5", event);
                //_00('enter', event);
            });
              $(".notes-model").click(function (event) {
                var row = $("#tblreviewIntellicheck tbody tr.selected");
