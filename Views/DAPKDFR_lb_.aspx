<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="DAPKDFR_lb_.aspx.cs" Inherits="conns.DAPKDFR_lb_Form"  MasterPageFile="~/Themes/Current/MasterPage.master" %>
<%@ Register  TagPrefix="mdf" Assembly="ASNA.Monarch.WebDspF, Version=12.0.48.0, Culture=neutral, PublicKeyToken=71de708db13b26d3" Namespace="ASNA.Monarch.WebDspF" %>

    <asp:Content ContentPlaceHolderID="HeaderPH" runat="Server" >
        <%-- Migrated on 4/19/2016 at 5:30 PM by ASNA Monarch(R) Wings version 7.0.58.0 --%>
        <%-- Legacy location: library ASNA3SRC, file QDDSSRC, member DAPKDFR# --%>
    ...
    <asp:Content ID="FileContent1" runat="server" ContentPlaceHolderID="FKeyPH">
        <div id="Div0">
            ...
            <mdf:ddsfile id="DAPKDFR_lb_Control" runat="server" 
                        ...
                        <div class="table-container filter-search-container">
                            <div class="content-grid mdl-grid">
                                ...
                                <div class="mdl-cell mdl-cell--10-col search-container">
                                    <div class="content-grid mdl-grid">
                                        <div class="mdl-cell mdl-cell--2-col" style=" width:  140px; ">
								...
								<div class="button-container">
										<div class="content-grid mdl-grid">
												...
												<span class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="byModelNumber" event-data='F13'>By Model NUMBER</span>
												 <span style="display:none;" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="next" onclick="_00('Enter', event);">next</span>
												</div>
										</div>
								</div>
						</div>
...
<script type="text/javascript">
 ...
 />
            <mdf:DdsConstant id="DdsConstant6" runat="server" 
              ...
              Text="Display SKU by Model Description" 
              CssClass="DdsConstant"
 />
 ...
 />
            <mdf:DdsConstant id="DdsConstant4" runat="server" 
              ...
              CssClass="DdsConstant"
 />
            <mdf:DdsCharField id="_lb_SFLCTL__lb_2A2TX" runat="server" style="position: absolute; left: 37px; top: 96px; width: 226px"
              CssClass="DdsCharField"
              Length="25" 
              Alias="#2A2TX" 
              Usage="Both" 
 ...
 />
            <mdf:DdsConstant id="DdsConstant15" runat="server" 
              style="position: absolute; left: 658px; top: 195px;"
              Text="Sts" 
              VisibleCondition="81"
              Color="DarkBlue" 
              CssClass="DdsConstant"
 ...
 />
            ...
            <mdf:DdsCharField id="_lb_SFLRCD__lb_1A2TX" runat="server" style="position: absolute; left: 64px; top: 0px; width: 226px"
              ...
              VirtualRowCol="11,4" 
 />
            <mdf:DdsCharField id="_lb_SFLRCD__lb_1AXTX" runat="server" style="position: absolute; left: 298px; top: 0px; width: 181px"
              CssClass="DdsCharField"
              Length="20" 
              Alias="#1AXTX" 
              Usage="OutputOnly" 
 ...
 />
            <mdf:DdsCharField id="_lb_SFLRCD__lb_1AXCD" runat="server" style="position: absolute; left: 568px; top: 0px; width: 28px"
              ...
              VirtualRowCol="11,60" 
 />
            <mdf:DdsCharField id="_lb_SFLRCD__lb_1AWCD" runat="server" style="position: absolute; left: 622px; top: 0px; width: 46px"
              CssClass="DdsCharField"
              Length="5" 
              Alias="#1AWCD" 
              Usage="OutputOnly" 
              VirtualRowCol="11,66" 
 />
            <mdf:DdsCharField id="_lb_SFLRCD__lb_1AXST" runat="server" style="position: absolute; left: 685px; top: 0px; width: 28px"
              CssClass="DdsCharField"
              Length="3" 
              Alias="#1AXST" 
              Usage="OutputOnly" 
 ...
 />
          ...
          <mdf:DdsRecord id="_lb_CMDTXT1" runat="server" 
            style="position: relative; width: 387px; height: 48px" 
            Alias="#CMDTXT1"
            CssClass="DdsRecord"
          >&nbsp;
          <%--  Command key text                                                                                                 --%>
 ...
 />
            <mdf:DdsConstant id="DdsConstant17" runat="server" 
              ...
              Text="F3=Exit   F12=Previous   F13=By ModelNbr" 
              CssClass="DdsConstant"
 />
          </mdf:DdsRecord >
