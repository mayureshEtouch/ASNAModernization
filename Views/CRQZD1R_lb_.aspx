...
<asp:Content ID="FileContent2" runat="server" ContentPlaceHolderID="CenPH"> 
      ...
      <section class="time-date">
        <div class="content-grid mdl-grid">
          <div class="mdl-cell mdl-cell--9-col"> 
            <!-- Title --> 
            <span class="heading-h1" id="heading">Credit Promotion Details</span> </div>
          <div class="mdl-cell mdl-cell--3-col pull-right"> 
            <!-- Navigation --> 
            <i class="material-icons md-15 md-light computer-icon"></i> <span class="date-time-txt">CRQZD1R</span> </div>
        </div>
      </section>
        ...
        <div class="form-data-wrapper form-div-first" style="padding-bottom:0; display:none;"> 
          ...
          <div class="content-grid mdl-grid"> 
            ...
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--8-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-label">Letter code:</span> </div>
          ...
          <div class="button-container">
            <div class="content-grid mdl-grid">
              <div class="mdl-cell mdl-cell--5-col mdl-cell--7-col-desktop" style="margin-left: 10px;"> <span class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="" event-data="F3">Exit</span> <span class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="prompt" event-data="F4">Prompt</span> <span class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="" event-data="F10">search</span> </div>
              <div class="mdl-cell mdl-cell--3-col mdl-cell--5-col-desktop pull-right modal-button-container"> <span class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="" event-data="Enter">Submit</span> </div>
            </div>
          </div>
        </div>
        <div class="form-data-wrapper form-div-second" style="padding-bottom:0;display:none;"> 
          ...
          <div class="content-grid mdl-grid"> 
            ...
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_1V5CD_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--8-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-label">Promotion:</span> </div>
                <div class="mdl-cell mdl-cell--4-col mdl-cell--3-col-tablet"> <span class="form-text" style="margin-left: -12px;" id="CenPH__lb_RCDDTL1__lb_1V5CD_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
            <!-- col starts here -->
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_DAZNA_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--6-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-label">Description:</span> </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--3-col-tablet"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_DAZNA_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
			<!-- col starts here -->
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_DJEXT_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--6-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-label">SB:</span> </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--3-col-tablet"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_DJEXT_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
            ...
            <!-- col starts here -->
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--2-col-tablet" style="padding:0"> </div>
            <!-- col ends here --> 
          ...
          <div class="content-grid mdl-grid"> 
            ...
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_1ANCO_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--8-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-label">Promo Letter Code:</span> </div>
                <div class="mdl-cell mdl-cell--4-col mdl-cell--3-col-tablet"> <span class="form-text" style="margin-left: -12px;" id="CenPH__lb_RCDDTL1__lb_1ANCO_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
            <!-- col starts here -->
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1_VDCJDT_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--6-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-label">Start Date:</span> </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--3-col-tablet"> <span class="form-text" id="CenPH__lb_RCDDTL1_VDCJDT_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
            <!-- col starts here -->
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--2-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1_VDCLDT_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-label">End Date:</span> </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet"> <span class="form-text" id="CenPH__lb_RCDDTL1_VDCLDT_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
          ...
          <div class="content-grid mdl-grid"> 
            ...
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--8-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_DECNU_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--8-col mdl-cell--2-col-tablet" style="margin:0"> <span class="form-label">CLI Offered - Credit Line Increase: </span> </div>
                <div class="mdl-cell mdl-cell--4-col mdl-cell--5-col-tablet tablet-mrgleft"> <span class="form-text"><span id="CenPH__lb_RCDDTL1__lb_DECNU_new" style="margin-left: -12px;"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
          </div>
          ...
          <div class="content-grid mdl-grid"> 
            ...
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_1V6CD_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--8-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-label">First Name:</span> </div>
                <div class="mdl-cell mdl-cell--4-col mdl-cell--3-col-tablet"> <span class="form-text" style="margin-left: -12px;" id="CenPH__lb_RCDDTL1__lb_1V6CD_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
            <!-- col starts here -->
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--2-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_1V7CD_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--6-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-label">Middle Initial:</span> </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--3-col-tablet"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1V7CD_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
            <!-- col starts here -->
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--6-col mdl-cell--3-col-tablet" style="margin:0"> <span class="form-label">Last Name:</span> </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--2-col-tablet"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1V8CD_new"></span> </div>
          ...
          <div class="content-grid mdl-grid"> 
            ...
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_1BSCR_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--8-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-label">Suffix:</span> </div>
                <div class="mdl-cell mdl-cell--4-col mdl-cell--3-col-tablet"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1WBCD_new"  style="margin-left: -12px;">I</span></div>
              </div>
            </div>
            <!-- col ends here --> 
            ...
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_1BSCR_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--6-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-label">Beacon Score:</span> </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--3-col-tablet"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1BSCR_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
            <!-- col starts here -->
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_1SSN_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--6-col mdl-cell--3-col-tablet" style="margin:0"> <span class="form-label">SSN:</span> </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--5-col-tablet"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1SSN_new"></span> <a id="ssn-show" style="color:blue;cursor: pointer; display:none;" href="javascript:void(0);">Show</a> </div>
              </div>
            </div>
            <!-- col ends here --> 
          ...
          <div class="content-grid mdl-grid"> 
            <!-- col starts here -->
            <div class="mdl-cell mdl-cell--8-col mdl-cell mdl-cell--5-col-tablet" style="padding:0">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--4-col mdl-cell--2-col-tablet" style="margin:0"> <span class="form-label">Address:</span> </div>
                <div class="mdl-cell mdl-cell--8-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1V9CD_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
            <!-- col starts here -->
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_1WCCD_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--6-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-label">Criteria Code:</span> </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--3-col-tablet"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1WCCD_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
          ...
          <div class="content-grid mdl-grid"> 
            ...
            <div class="mdl-cell mdl-cell--8-col mdl-cell mdl-cell--5-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_1CVCO_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--4-col mdl-cell--2-col-tablet" style="margin:0">  </div>
                <div class="mdl-cell mdl-cell--8-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1CVCO_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
            <!-- col starts here -->
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0" id="">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--6-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-label">Invoice Number:</span> </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--3-col-tablet" > <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1GZNB_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
          ...
          <div class="content-grid mdl-grid"> 
            ...
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_1CITY_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--8-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-label">Curr City:</span> </div>
                <div class="mdl-cell mdl-cell--4-col mdl-cell--3-col-tablet"> <span class="form-text" style="margin-left: -12px;" id="CenPH__lb_RCDDTL1__lb_1CITY_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
            <!-- col starts here -->
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_1STE_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--6-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-label">Curr State:</span> </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--3-col-tablet"> <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1STE_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
            <!-- col starts here -->
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--2-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_1ZIP_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet" style="margin:0"> <span class="form-label">Curr Zip:</span> </div>
                <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet" > <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1ZIP_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
          ...
          <div class="content-grid mdl-grid"> 
            ...
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_1LRST_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--8-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-label">Used Status:</span> </div>
                <div class="mdl-cell mdl-cell--4-col mdl-cell--3-col-tablet"> <span class="form-text" style="margin-left: -12px;" id="CenPH__lb_RCDDTL1__lb_1LRST_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
            <!-- col starts here -->
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--3-col-tablet" style="padding:0" id="">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--8-col mdl-cell--5-col-tablet" style="margin:0"> <span class="form-label">Used Date:</span> </div>
                <div class="mdl-cell mdl-cell--4-col mdl-cell--3-col-tablet"  style="margin-left: 2px;"> <span class="form-text" id="CenPH__lb_RCDDTL1_V1UDTE_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
            <!-- col starts here -->
            <div class="mdl-cell mdl-cell--4-col mdl-cell mdl-cell--2-col-tablet" style="padding:0">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--8-col mdl-cell--5-col-tablet" style="margin:0"> </div>
                <div class="mdl-cell mdl-cell--4-col mdl-cell--3-col-tablet"> </div>
              </div>
            </div>
            <!-- col ends here --> 
          ...
          <div class="content-grid mdl-grid"> 
            <!-- col starts here -->
            <div class="mdl-cell mdl-cell--10-col mdl-cell mdl-cell--8-col-tablet" style="padding:0" id="CenPH__lb_RCDDTL1__lb_DYQTX_new_div">
              <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--3-col mdl-cell--1-col-tablet" style="margin:0"> <span class="form-label">Notes:</span> </div>
                <div class="mdl-cell mdl-cell--9-col mdl-cell--5-col-tablet"> <span class="form-text" style="margin-left: -8px;" id="CenPH__lb_RCDDTL1__lb_DYQTX_new"></span> </div>
              </div>
            </div>
            <!-- col ends here --> 
          ...
          <div class="button-container">
            <div class="content-grid mdl-grid">
              <div class="mdl-cell mdl-cell--5-col mdl-cell--7-col-desktop" style="margin-left: 10px;"> <span class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="" event-data="F3">Exit</span> </div>
              <div class="mdl-cell mdl-cell--3-col mdl-cell--5-col-desktop pull-right modal-button-container"> <span class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="" event-data="Enter">Submit</span> </div>
            </div>
          </div>
        </div>
  ...
  <script type="text/javascript">
        ...
        var copyToAndFrom2 = {
          "displayOnlyFields": {
			...
			"CenPH__lb_RCDDTL1__lb_DJEXT":"CenPH__lb_RCDDTL1__lb_DJEXT_new",
        ...
        if($("#CenPH__lb_RCDKEY__lb_1ANCO").length>0){
          $(".form-div-first").show();
		  $('#CenPH__lb_RCDDTL1__lb_DJEXT_new_div').hide();
         ...
         $.each(copyToAndFrom2['displayOnlyFields'],function(i,el){
           if($("#"+copyToAndFrom2['displayOnlyFields'][i]).html()==''){
			 ...
			 $('#CenPH__lb_RCDDTL1__lb_DJEXT_new_div').show();
           }
         });
 ...
 />
            <mdf:DdsConstant id="DdsConstant15" runat="server" 
              style="position: absolute; left: 622px; top: 51px;"
              Text="SB" 
              Color="Blue" 
              CssClass="DdsConstant"
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_DJEXT" runat="server" style="position: absolute; left: 649px; top: 48px; width: 64px"
              CssClass="DdsCharField"
              Length="7" 
              Alias="#DJEXT" 
              Usage="OutputOnly" 
