...
<div class="modal-dialog-container">
	<header class="mdl-layout__header">
		<div class="mdl-layout__header-row">
			...
			<span class="close-icon" id="close" event-data="F3"><i class="material-icons md-15 close"></i></span>
		</div>
	</header>
	...
	<main class="mdl-layout__content second-view" style="display:none;">
		<section class="time-date">
			<div class="content-grid mdl-grid">
				<div class="mdl-cell mdl-cell--9-col">
					<!-- Title -->
		...
		<section class="form-data">
			<div class="form-data-wrapper" style="padding-bottom: 0;">
				...
				<div class="content-grid mdl-grid">
					...
					<div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet" style="padding: 0">
						<div class="content-grid mdl-grid">
							<div class="mdl-cell mdl-cell--4-col mdl-cell--2-col-tablet" style="margin: 0"><span class="form-label">Customer ID:</span> </div>
							<div class="mdl-cell mdl-cell--5-col mdl-cell--6-col-tablet" style="margin: 0">
							<input type="text" id="CenPH__lb_RCDKEY__lb_1ALNB_new" maxlength="7" onfocus="_09('#1ALNB','4,31','#RCDKEY')">
							</div>
						</div>
					</div>
					<!-- col ends here -->
					...
					<div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet" style="padding: 0">
						<div class="content-grid mdl-grid">
							<div class="mdl-cell mdl-cell--4-col mdl-cell--2-col-tablet" style="margin: 0"><span class="form-label">Sequence:</span> </div>
							<div class="mdl-cell mdl-cell--5-col mdl-cell--6-col-tablet" style="margin: 0">
							<input type="text" id="CenPH__lb_RCDKEY__lb_1SEQ_lb__new" maxlength="5" onfocus="_09('#1SEQ#','5,31','#RCDKEY')">
							</div>
						</div>
					</div>
					<!-- col ends here -->
...
<script type="text/javascript">
	...
	var copyToAndFrom2 = {
		...
		"inputFields": {
			...
			"CenPH__lb_RCDKEY__lb_1SEQ_lb_": "CenPH__lb_RCDKEY__lb_1SEQ_lb__new"
		}
	}
