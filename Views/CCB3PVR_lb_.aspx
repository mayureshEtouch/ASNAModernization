<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="CCB3PVR_lb_.aspx.cs" Inherits="conns.CCB3PVR_lb_Form"  MasterPageFile="~/Themes/Current/MasterPage.master" %>
<%@ Register  TagPrefix="mdf" Assembly="ASNA.Monarch.WebDspF, Version=12.0.48.0, Culture=neutral, PublicKeyToken=71de708db13b26d3" Namespace="ASNA.Monarch.WebDspF" %>

    <asp:Content ContentPlaceHolderID="HeaderPH" runat="Server" >
        <%-- Migrated on 4/18/2016 at 3:32 PM by ASNA Monarch(R) Wings version 7.0.58.0 --%>
        <%-- Legacy location: library asnaDSRC, file QDDSSRC, member CCB3PVR# --%>
    ...
    <asp:Content ID="FileContent1" runat="server" ContentPlaceHolderID="FKeyPH">
        <div id="Div0">
            ...
            <mdf:ddsfile id="CCB3PVR_lb_Control" runat="server" 
    ...
    <!-- Modified HTML code ends here -->
      ...
      <%-- =========================================================================        --%>
          <mdf:DdsRecord id="_lb_RCDDTL1" runat="server" 
            ...
            FuncKeys="F4 'Prompt.' 04;F5 'Reset.' 05;F12 'CF12.' 12;"
