<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="DIQ3PVI_lb_.aspx.cs" Inherits="conns.DIQ3PVI_lb_Form"  MasterPageFile="~/Themes/Current/MasterPage.master" %>
<%@ Register  TagPrefix="mdf" Assembly="ASNA.Monarch.WebDspF, Version=12.0.48.0, Culture=neutral, PublicKeyToken=71de708db13b26d3" Namespace="ASNA.Monarch.WebDspF" %>

    <asp:Content ContentPlaceHolderID="HeaderPH" runat="Server" >
        <%-- Migrated on 8/16/2016 at 8:19 PM by ASNA Monarch(R) Wings version 7.0.58.0 --%>
        <%-- Legacy location: library asnaph4bk, file QDDSSRC, member DIQ3PVI# --%>
    ...
    <asp:Content ID="FileContent1" runat="server" ContentPlaceHolderID="FKeyPH">
        <div id="Div0">
            ...
            <mdf:ddsfile id="DIQ3PVI_lb_Control" runat="server" 
...
<div class="modal-dialog-container">
    ...
    <section class="time-date">
      <div class="content-grid mdl-grid">
        <div class="mdl-cell mdl-cell--9-col"> 
          <!-- Title --> 
          <span class="heading-h1">Display Customer Address</span> 
        </div>
        <div class="mdl-cell mdl-cell--3-col pull-right"> 
          <!-- Navigation --> 
          <i class="material-icons md-15 md-light computer-icon"></i> <span class="date-time-txt">DIQ3PVI</span>
        </div>
      </div>
    </section>
      ...
      <div class="order-summary-wrapper">
        <div class="content-grid mdl-grid">
          <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
            ...
            <span class="summary-txt" id="CenPH__lb_RCDDTL1__lb_1CGC_lb_new"></span>
          </div>
          <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
            <span class="summary-title">Version Number</span>
            <span class="summary-txt" id="CenPH__lb_RCDDTL1__lb_1P6N_lb_new"></span>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="mdl-cell mdl-cell--12-col mdl-cell--8-col-tablet" style="padding:0">
            <div class="content-grid mdl-grid">
              ...
              <div class="mdl-cell mdl-cell--9-col mdl-cell--6-col-tablet" style="margin:0">
                <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1P3N_lb_new"></span>
              </div>
            </div>
          </div>
        </div>
          ...
          <!-- col starts here -->
            ...
            <div class="content-grid mdl-grid">
              <div class="mdl-cell mdl-cell--3-col mdl-cell--2-col-tablet" style="margin:0">
                          ...
                          <div class="mdl-cell mdl-cell--9-col mdl-cell--6-col-tablet" style="margin:0">
                              <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1J0XT_new"></span><br/>
                <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1J1XT_new"></span>
                          </div>
            </div>
          </div>
          <!-- col ends here -->
          ...
          <!-- col starts here -->
            ...
            <div class="content-grid mdl-grid">
              <div class="mdl-cell mdl-cell--3-col mdl-cell--2-col-tablet" style="margin:0">
                          ...
                          <div class="mdl-cell mdl-cell--9-col mdl-cell--6-col-tablet" style="margin:0">
                              <span class="form-text" id="CenPH__lb_RCDDTL1__lb_1J2XT_new"></span><span class="form-text mrgnLft10" id="CenPH__lb_RCDDTL1__lb_DAQTX_new"></span><span class="form-text mrgnLft10" id="CenPH__lb_RCDDTL1__lb_DADST_new"></span>
                          </div>
            </div>
          </div>
          <!-- col ends here -->
  ...
  <div class="simplePopupBackground1" style="display:none; opacity: 0.7; background: #000;position: absolute;height: 100%; width: 100%; top: 0; left: 0;z-index: 3;"></div>
    <div id="modal" class="simplePopup"></div>
      ...
      <%--  CU: PMT Dsp Cust Addr     Prompt & validate record                                                   --%>
      <%--  CRTDSPF                                                                                              --%>
      <%--  RSTDSP(*YES)                                                                                         --%>
      <%--  MEMBER-ID: DIQ3PVI#                                                                                  --%>
      <%--                                                                                                       --%>
 ...
 />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_1ALNB" runat="server" style="position: absolute; left: 1px; top: 0px; width: 64px"
              ...
              Usage="Hidden" 
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_1JZXT" runat="server" style="position: absolute; left: 1px; top: 0px; width: 271px"
 ...
 />
            <mdf:DdsConstant id="DdsConstant4" runat="server" 
              ...
              CssClass="DdsConstant"
 />
            <mdf:DdsCharField id="_lb_RCDDTL1__lb_1CGC_lb_" runat="server" style="position: absolute; left: 109px; top: 24px; width: 28px"
              CssClass="DdsCharField"
              Length="3" 
              Alias="#1CGC#" 
              Usage="OutputOnly" 
 ...
 />
            <mdf:DdsConstant id="DdsConstant6" runat="server" 
              ...
              CssClass="DdsConstant"
 />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_1P5N_lb_" runat="server" style="position: absolute; left: 163px; top: 24px; width: 82px"
              CssClass="DdsDecField"
              Length="9" 
              Decimals="0" 
              Alias="#1P5N#" 
 ...
 />
            <mdf:DdsConstant id="DdsConstant7" runat="server" 
              ...
              CssClass="DdsConstant"
 />
            <mdf:DdsDecField id="_lb_RCDDTL1__lb_1P6N_lb_" runat="server" style="position: absolute; left: 271px; top: 24px; width: 28px"
              CssClass="DdsDecField"
              Length="3" 
              Decimals="0" 
              Alias="#1P6N#" 
      ...
      <script type="text/javascript">
        var copyToAndFrom = {
                "displayOnlyFields": {
                    ...
                    "CenPH__lb_RCDDTL1__lb_1P6N_lb_": "CenPH__lb_RCDDTL1__lb_1P6N_lb_new",
