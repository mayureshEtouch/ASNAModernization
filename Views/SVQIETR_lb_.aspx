        ...
        <section class="time-date">
            <div class="content-grid mdl-grid">
                <div class="mdl-cell mdl-cell--8-col">
                    <!-- Title -->
                    <span class="heading-h1">Workorder Entry - Manual</span>
                </div>
                <div class="mdl-cell mdl-cell--4-col pull-right">
                    <!-- Navigation -->
                    <i class="material-icons md-15 md-light computer-icon"></i><span class="date-time-txt">SVQIETR</span> <i class="material-icons md-15 md-light date-icon"></i> <span class="date-time-txt" name="date" id="date"></span> <i class="material-icons md-15 md-light time-icon"></i> &nbsp;<span class="date-time-txt" name="time" id="time"></span>
                </div>
            </div>
        </section>
                            ...
                            <div class="mdl-cell mdl-cell--4-col mdl-cell--3-col-tablet">
                                <div class="content-grid mdl-grid">
                                    ...
                                    <div class="mdl-cell mdl-cell--7-col" style="margin: 0;">
                                        ...
                                        <input class="mdl-textfield__input input-mrgnTp zip-input" type="text" data-tb-index="1" size="5" id="repairLoc3" onfocus="_09('#CESTX','7,70','#SFLCTL');" maxlength="10" style="width: 85px;"> 
                       ...
                       <%-- <div class="content-grid mdl-grid">
                            <div class="mdl-cell mdl-cell--12-col" style="margin: 0 38px;">
                                <fieldset id="problem-description">
                                    <legend id="specialInstructions">Problem Description:</legend>
